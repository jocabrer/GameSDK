	...
	{
		{
			...
			classes =
			{
				...
				{ class = "office_desk_tow_packed"                , percent = 7.69  },
				{ class = "umbrella_open_tow_packed"              , percent = 7.69  }, 
				{ class = "mapsign_tow_packed"                    , percent = 7.69  },
				{ class = "gnome_giant_c"                         , percent = 7.69  },
				{ class = "arcade_cabinet"                        , percent = 7.69  },
				{ class = "oil_rack_storage_packed"				  , percent = 7.69  },
				{ class = "toilet_tow_packed"   				  , percent = 7.69  },
				{ class = "icemachine_tow_packed"				  , percent = 7.69  },
				{ class = "vendingmachine_2_tow_packed"	  	      , percent = 7.69  },
				{ class = "vendingmachine_1_tow_packed"			  , percent = 7.69  },
				{ class = "mailbox_storage_packed"   			  , percent = 7.69  },
				{ class = "whiteboard_tow_packed"   			  , percent = 7.69  },
				{ class = "payphone_tow_packed"   			      , percent = 7.69  },
