	...
	{
		{
			...
			classes =
			{
				...
				{ class = "posed_skeleton_onground_tow_packed"    , percent = 5 },
				{ class = "gnome_giant_c"                         , percent = 10 },
				{ class = "arcade_cabinet"                        , percent = 10 },
                { class = "fridge_modern_tow_packed"			  , percent = 5 }, 
				{ class = "oil_rack_storage_packed"				  , percent = 5 },
				{ class = "toilet_tow_packed"   				  , percent = 5 },
				{ class = "filecab_01_tow_packed"				  , percent = 5 },
				{ class = "icemachine_tow_packed"				  , percent = 5 },
				{ class = "vendingmachine_2_tow_packed"	  	      , percent = 5 },
				{ class = "vendingmachine_1_tow_packed"			  , percent = 5 },
				{ class = "mailbox_storage_packed"   			  , percent = 5 },
				{ class = "whiteboard_tow_packed"   			  , percent = 5 },
