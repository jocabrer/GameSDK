			...
			{
				{
					...
					models =
                    {
                        { name = "objects/characters/mutants/brutemutant/brute_mutant_clothed_01.cdf"     , percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_mutant_clothed_02.cdf"     , percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_mutant_dark.cdf"           , percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_mutant_clothed_01_dark.cdf", percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_mutant_clothed_02_dark.cdf", percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_mutant.cdf"                , percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_mutant_armored.cdf"        , percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_mutant_armored_dark.cdf"   , percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_mutant_es_armored_dark.cdf", percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_mutant_armored_es1.cdf"    , percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_mutant_armored_es2.cdf"    , percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_humanoid.cdf"              , percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_humanoid1.cdf"             , percent = 7.14 },
                        { name = "objects/characters/mutants/brutemutant/brute_humanoid2.cdf"             , percent = 7.14 },
                    },
				},
			},
		},
			...
			{
				{
					...
					models =
					{
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_clothed_01.cdf"     , percent = 12.5 },
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_clothed_02.cdf"     , percent = 12.5 },
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_dark.cdf"           , percent = 12.5 },
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_clothed_01_dark.cdf", percent = 12.5 },
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_clothed_02_dark.cdf", percent = 12.5 },
						{ name = "objects/characters/mutants/brutemutant/brute_mutant.cdf"                , percent = 12.5 },
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_armored.cdf"        , percent = 12.5 },
						{ name = "objects/characters/mutants/brutemutant/brute_mutant_armored_dark.cdf"   , percent = 12.5 },
					},
				},
			},
		},
