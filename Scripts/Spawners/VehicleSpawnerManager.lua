	...
	vehicleCategories =
	{
		...
		------------------------------------------------ SUBARU BRZ
		{
			...
			classes =
			{
				{
					class = "placeholder12",
					contents = "RandomPoliceSedanContents",
					skins =
					{
		...
		------------------------------------------------
		{
			...
			classes =
			{
				...
				{
					class = "truck_semi",
					contents = "RandomTruck5TonContents",
					skins =
					{
						-- If the total doesn't equal 100% then the remainder will spawn with the default skin
			...
			{
				{
					...
					class = "quadbike",
					contents = "RandomQuadBikeContents",
					skins =
					{
						-- If the total doesn't equal 100% then the remainder will spawn with the default skin
		...
		------------------------------------------------
		{
			...
			classes =
			{
				{
					class = "fishing_boat",
					contents = "RandomFishingBoatContents",
					skins =
					{
						-- If the total doesn't equal 100% then the remainder will spawn with the default skin
		...
		------------------------------------------------
		{
			...
			classes =
			{
				...
				-- Hyundai genesis
				{
					...
					skins =
					{
						{ name = "placeholder10_black", percent = 20 },
						{ name = "placeholder10_blue",  percent = 20 },
						{ name = "placeholder10_green", percent = 20 },
						{ name = "placeholder10_brown", percent = 20 },
						{ name = "placeholder10_grey",  percent = 20 },
