	...
	itemCategories =
	{
		...
		
		{
			...
			classes =
			{
                ...
                { class = "RandomCargador"          , percent = 79.5},
			},
		},
		...
		-- Custom Metal Parts
		{
			...
			classes =
			{
				...
				{ class = "plastered_wall_green_3m_4m_door"          , percent = 0.5    },
				...
				{ class = "brick_wall_3m_4m_door"                    , percent = 0.5    },
				{ class = "rock_doorway_3m_4m"                       , percent = 0.5    },
				{ class = "glass_wall_1_3m_4m"                       , percent = 3      },
				{ class = "glass_door_3m_2m"                         , percent = 0.5    },
				{ class = "window"                                   , percent = 3      },
				{ class = "glass_wall_2m_4m"                         , percent = 3      },
				{ class = "glass_wall_3m_4m"                         , percent = 1.5    },
		...
		
		{
			...
			group =
			{
                ...
                { class = "ConcreteBag"       			   , percent = 100  , min = 3, max = 15 },
                { class = "ConcreteBag"       			   , percent = 50   , min = 3, max = 15 },
				{ category = "RandomPaintCan"              , percent = 80  },
                { category = "RandomGlassParts"            , percent = 80  },
                { class = "UFOStorage_Crate_packed"        , percent = 1   },
                { class = "epic_gold_crate_packed"         , percent = 1   },
		...
		
		{
            ...
            group =
            {
				...
				{ class = "PlasmaRifle"			   		        , percent = 5 	 },
				{ class = "RocketLauncherNew"			        , percent = 15 	 },
                { class = "SAPOCBriefcaseClosed"                , percent = 50   },
