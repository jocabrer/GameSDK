	...
	itemCategories =
	{
		...
		-- AI
		{
			...
			group =
			{
                ...
                { category  = "RandomConsumable"         , percent = 60  },
                { category  = "RandomClothes"            , percent = 25  },
			},
		},
...

		{
			...
			group =
			{
				...
				{ class     = "AmcoinLedger",             percent = 50    , min = 1, max = 5 },
		...
		-- Consumables
		{
			...
			classes =
			{
				...
				{ class = "WaterPurificationTablets", percent = 3  , min = 1, max = 1},
		...
		-- Medical
		{
			...
			classes =
			{
				{ class = "AdrenalineSyringe"       , percent = 6  },
				{ class = "AntiradiationPills"      , percent = 6  },
				{ class = "PotassiumIodidePills"    , percent = 6  },
				{ class = "Antibiotics"             , percent = 6  },
				{ class = "Aspirin"                 , percent = 6  },
				{ class = "Bandage"                 , percent = 25 },
				{ class = "HeatPack"                , percent = 10 },
				{ class = "WaterPurificationTablets", percent = 5   , min = 1, max = 1},
				{ class = "Rags"                    , percent = 15 },
				{ class = "RubbingAlcohol"          , percent = 8  },
				{ class = "Salt"                    , percent = 7  },
...

		{
			...
			classes =
			{
				...
				{ class = "WaterPurificationTablets"   , percent = 1.5   , min = 1, max = 1},
				{ category = "RandomTent"              , percent = 1    },
...

		{
			...
			classes =
			{
				...
				{ class = "WaterPurificationTablets", percent = 2    , min = 1, max = 1},
                { class = "SCAAMAmalgarmin"         , percent = 5   }, 
			},
		},
...

		{
			...
			classes =
			{
				...
				{ category = "RandomSeeds"             , percent = 5  },
				{ class    = "WaterPurificationTablets", percent = 1   , min = 1, max = 1},
		...
		
		{
			...
			group =
			{
				...
				{ category = "RandomCargador"          , percent = 100 , min = 20, max = 30  },
                { category = "RandomCargador"          , percent = 100 , min = 20, max = 30  },
                { category = "RandomAmmo"              , percent = 100 , min = 1, max = 1    },
                { category = "RandomAmmoBox"           , percent = 100 },
				{ category = "RandomAmmoBox"           , percent = 100 },
		...
		
		{
			...
			group =
			{
                ...
                { category = "RandomMetalParts"              , percent = 100 },
                { class = "SAPOCBriefcaseClosed"             , percent = 5   , min = 1, max = 1     },
                { class = "SAPOCBriefcaseClosed"             , percent = 5   , min = 1, max = 1     },
				{ category = "RandomAmmo"            	     , percent = 100  , min = 1, max = 1 },
                { class = "Mk18Reaver"                       , percent = 2   },
                ...
                { category = "CrossbowWithMagazines"	     , percent = 10  },
		...
		
		{
			...
			group =
			{
                ...
                { category = "RandomFireStarter"        , percent = 100  },
                { category = "RandomAccessory"          , percent = 100  },
				...
				{ category = "RandomRangedPure"         , percent = 100  },
				{ category = "RandomEpicWeapon"         , percent = 90  },
                { class = "SAPOCBriefcaseClosed"        , percent = 15   , min = 1, max = 1     },
                { class = "SAPOCBriefcaseClosed"        , percent = 8   , min = 1, max = 1     },
