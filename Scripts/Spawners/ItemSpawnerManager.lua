	...
	itemCategories =
	{
...

		{
			...
			classes =
			{
				...
				{category = "RandomCraftedTools"         , percent = 20  , min = 1, max = 2 },
...

		{
			...
			classes =
			{
                ...
                { category 			   = "RandomAccessory"       , percent = 69  },
		...
		-- Neck
		{
			...
			classes =
			{
				...
				{ class = "NecklaceCrossChrome", percent = 40 },
...

		{
			...
			classes =
			{
                ...
                { class = "guide_concrete", percent = 15 },
		...
		-- Custom Metal Parts
		{
			...
			classes =
			{
				...
				-- walls (20)
				{ class = "concrete_wall_3m_2m_white", percent = 2 },
				...
				{ class = "rock_wall_3m_4m", percent = 10 },
				-- special walls (10)
				{ class = "plastered_wall_black_3m_2m_window", percent = 6 }, 
				{ class = "plastered_wall_green_3m_4m_door", percent = 1 },
				{ class = "plastered_wall_red_3m_4m", percent = 3 },
				-- special (20)
				{ class = "plastered_angled_roof_3x4x4", percent = 5 },
				{ class = "classic_platform_3m_4m_4m", percent = 5 },
				{ class = "brick_column_3m", percent = 5 },
				{ class = "brick_wall_3m_2m", percent = 1 },
				{ class = "cobblestone_column_3m", percent = 1 },
				{ class = "cobblestone_platform_3m_4m_4m", percent = 3 },
				-- gatehouse (20)
				{ class = "brick_wall_3m_4m_door", percent = 7 },
				{ class = "rock_doorway_3m_4m", percent = 7 },
				{ class = "glass_wall_1_3m_4m", percent = 3 },
				{ class = "glass_door_3m_2m", percent = 3 },
				-- misc (20)
				{ class = "window", percent = 10 },
...

		{
			...
			group =
			{
				...
				{ class = "GingerBreadMan"                   , percent = 100 , min = 2, max = 5},
				{ class = "titanium_wall_3m_4m"     		 , percent = 80  , min = 2, max = 5},
				{ class = "titanium_platform_3m_4m_4m_stairs", percent = 80                    },
				{ class = "titanium_wall_3m_4m"     		 , percent = 50  , min = 5, max = 8},
		...
		
		{
			...
			group =
			{
				...
				{ category = "RandomMetalParts", percent = 6 },
				{ category = "RandomMetalParts", percent = 3 },
				{ class = "ConcreteBag", percent = 100, min = 1, max = 10 },
                { class = "ConcreteBag", percent = 100, min = 1, max = 10 },
				{ class = "SheetMetal", percent = 100, min = 64, max = 128 },
		...
		
		{
            ...
            group =
            {
                ...
                { class = "SpaceHelmet", percent = 100 },
    			{ category = "RandomDuffelBag", percent = 100 },
				{ class = "cabin_wood_black", percent = 5},
