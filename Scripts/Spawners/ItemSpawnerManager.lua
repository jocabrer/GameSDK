	...
	itemCategories =
	{
		...
		-- A random epic spawn for hard to reach areas. Use sparingly.
		{
			...
			classes =
			{
				...
				{ category = "AKMGoldWithMagazines"          , percent = 15 },
				{ category = "ColtPythonGrimeyRickWithRounds", percent = 5  },
				{ category = "M4A1WithMagazines"             , percent = 15 },
				{ category = "M16VietnamWithMagazines"       , percent = 15 },
				{ category = "VSSWithMagazines"              , percent = 3  },
		...
		-- AI
		{
			...
			group =
			{
				...
				{ class    = "AmcoinLedger"    , percent = 25   , min = 1, max = 7},
				{ category = "RandomAmmo"      , percent = 80 },
...

		{
			...
			group =
			{
				...
				{ class     = "OpticScope",  		    percent = 5  	}, -- Christmas event
			},
		},
...

		{
			...
			classes =
			{
				...
				{ category             = "RandomClothes"         , percent = 3   },
				{ category             = "RandomCrafting"        , percent = 3   },
		...
		-- Special Police Spawner
		{
			...
			classes =
			{
				...
				{ category = "RandomPoliceArmor"              , percent = 4   },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomMilitaryGloves"     , percent = 14.2 },
				{ category = "RandomMilitaryHelmet"     , percent = 14.2 },
				{ category = "RandomMilitaryJacket"     , percent = 14.2 },
				{ category = "RandomMilitaryShoes"      , percent = 14.2 },
                { category = "RandomIronSuite"          , percent = 14.2 },
			},
		},
		...
		-- Civilian Hunting Items Spawner
		{
			...
			classes =
			{
				...
				{ category  = "RandomHuntingClothing"   , percent = 25  },
		...
		-- Used in presents and easter eggs
		{
			...
			classes =
			{
                ...
                { category = "RandomIronSuite"			  , percent = 7 },
...

		{
			...
			classes =
			{
				{ class = "DuffelBag"          , contents="RandomBackpackContents", percent = 5  },
				{ class = "DuffelBagBlack"     , contents="RandomBackpackContents", percent = 5  },
				{ class = "DuffelBagGreen"     , contents="RandomBackpackContents", percent = 10 },
				{ class = "DuffelBagGreenCamo1", contents="RandomBackpackContents", percent = 5  },
				{ class = "DuffelBagGreenCamo2", contents="RandomBackpackContents", percent = 5  },
				{ class = "DuffelBagGreenCamo3", contents="RandomBackpackContents", percent = 5  },
				{ class = "DuffelBagGreenCamo4", contents="RandomBackpackContents", percent = 10 },
				{ class = "DuffelBagTanCamo1"  , contents="RandomBackpackContents", percent = 5  },
				{ class = "DuffelBagTanCamo2"  , contents="RandomBackpackContents", percent = 10 },
				{ class = "DuffelBagTanCamo3"  , contents="RandomBackpackContents", percent = 5  },
				{ class = "DuffelBagTanCamo4"  , contents="RandomBackpackContents", percent = 10 },
				{ class = "DuffelBagUrbanCamo1", contents="RandomBackpackContents", percent = 5  },
				{ class = "DuffelBagUrbanCamo2", contents="RandomBackpackContents", percent = 5  },
				{ class = "DuffelBagUrbanCamo3", contents="RandomBackpackContents", percent = 10 },
				{ class = "DuffelBagUrbanCamo4", contents="RandomBackpackContents", percent = 5  },
				{ class = "DuffelBagLightBlue" , contents="RandomBackpackContents", percent = 5   },
				{ class = "DuffelBagOGreen"    , contents="RandomBackpackContents", percent = 5   },
				{ class = "DuffelBagYellow"    , contents="RandomBackpackContents", percent = 5   },
				{ class = "DuffelBagBlue"      , contents="RandomBackpackContents", percent = 5   },
				{ class = "DuffelBagPurple"    , contents="RandomBackpackContents", percent = 5   },
				{ class = "DuffelBagPink"      , contents="RandomBackpackContents", percent = 5   },
				{ class = "DuffelBagRed"       , contents="RandomBackpackContents", percent = 5   },
				{ class = "DuffelBagWhite"     , contents="RandomBackpackContents", percent = 5   },
...

		{
			...
			classes =
			{
				{ class = "DuffelBag"          , contents="RandomBackpackAirPlaneContents"  , percent = 5  },
				{ class = "DuffelBagBlack"     , contents="RandomBackpackAirPlaneContents"  , percent = 5  },
				{ class = "DuffelBagGreen"     , contents="RandomBackpackAirPlaneContents"  , percent = 10 },
				{ class = "DuffelBagGreenCamo1", contents="RandomBackpackAirPlaneContents"  , percent = 5  },
				{ class = "DuffelBagGreenCamo2", contents="RandomBackpackAirPlaneContents"  , percent = 5  },
				{ class = "DuffelBagGreenCamo3", contents="RandomBackpackAirPlaneContents"  , percent = 5  },
				{ class = "DuffelBagGreenCamo4", contents="RandomBackpackAirPlaneContents"  , percent = 8  },
				{ class = "DuffelBagTanCamo1"  , contents="RandomBackpackAirPlaneContents"  , percent = 5  },
				{ class = "DuffelBagTanCamo2"  , contents="RandomBackpackAirPlaneContents"  , percent = 8  },
				{ class = "DuffelBagTanCamo3"  , contents="RandomBackpackAirPlaneContents"  , percent = 5  },
				{ class = "DuffelBagTanCamo4"  , contents="RandomBackpackAirPlaneContents"  , percent = 8  },
				{ class = "DuffelBagUrbanCamo1", contents="RandomBackpackAirPlaneContents"  , percent = 5  },
				{ class = "DuffelBagUrbanCamo2", contents="RandomBackpackAirPlaneContents"  , percent = 5  },
				{ class = "DuffelBagUrbanCamo3", contents="RandomBackpackAirPlaneContents"  , percent = 8  },
				{ class = "DuffelBagUrbanCamo4", contents="RandomBackpackAirPlaneContents"  , percent = 5  },
				{ class = "DuffelBagLightBlue" , contents="RandomBackpackContents"			, percent = 1  },
				{ class = "DuffelBagOGreen"    , contents="RandomBackpackContents"			, percent = 1  },
				{ class = "DuffelBagYellow"    , contents="RandomBackpackContents"			, percent = 1  },
				{ class = "DuffelBagBlue"      , contents="RandomBackpackContents"			, percent = 1  },
				{ class = "DuffelBagPurple"    , contents="RandomBackpackContents"			, percent = 1  },
				{ class = "DuffelBagPink"      , contents="RandomBackpackContents"			, percent = 1  },
				{ class = "DuffelBagRed"       , contents="RandomBackpackContents"			, percent = 1  },
				{ class = "DuffelBagWhite"     , contents="RandomBackpackContents"			, percent = 1  },
			},
		},
		...
		-- Back
		{
			...
			classes =
			{
				{ category = "BackpackComponents"              , percent = 30 },
				{ category = "RandomDuffelBag"                 , percent = 5  },
				{ category = "RandomStowPack"                  , percent = 30 },
				{ category = "RuggedPack"                      , percent = 15 },
				{ category = "RandomRuckSack"                  , percent = 15 },
				{ category = "RandomGasCanisterPackColored"    , percent = 5  },
		...
		-- Crafting
		{
			...
			classes =
			{
				...
				{ category = "RandomPaintCan"        , percent = 5 	},
		...
		
		{
			...
			classes =
			{
				...
				{ class = "propane_heater"                    , percent = 3 },
				{ class = "camping_lantern"                   , percent = 6 },
                { class = "camping_lantern_pink"  			  , percent = 6 },
                { class = "camping_lantern_red"   			  , percent = 7 },
                { class = "camping_lantern_aqua"  			  , percent = 6 },
                { class = "camping_lantern_blue"  			  , percent = 6 },
                { class = "camping_lantern_green" 			  , percent = 7 },
                { class = "camping_lantern_orange"			  , percent = 7 },
                { class = "camping_lantern_yellow"			  , percent = 7 },
                { class = "camping_lantern_purple"			  , percent = 7 },
		...
		-- largly based on random ranged weapon, rest from crafted
		{
			...
			classes =
			{
				...
				{ class = "RK_Icepickace"     , percent = 10   },
		...
		
		{
			...
			classes =
			{
				{ class = "FlakVestGreen"     , percent = 18   },
...

		{
			...
			classes =
			{
				...
				{ class = "ext_556x75"             , percent = 0.5  },
				{ class = "ext_762x75"             , percent = 0.5  },
				{ class = "STANAGx50"              , percent = 0.5  },
				{ class = "HuntingScope"		   , percent = 4    },
				{ class = "OpticScope"		   	   , percent = 4    },
				{ class = "akval_drummag_75rnd"	   , percent = 0.5  },
		...
		},
		{
			...
			classes =
			{
                ...
                { class = "Pile_556x45"          , percent = 3.5   },
                { class = "Pile_762x39"          , percent = 3.5   },
                { class = "Pile_762x51"          , percent = 4     },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomAccessory"              , percent = 35 },
                { category = "RandomSilencer"   			, percent = 5 },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomFullHazmatSet"         , percent = 6 },
				{ class = "DustMask"                       , percent = 15 },
		...
		-- Custom Metal Parts
		{
			...
			classes =
			{
				{ class = "brick_angled_roof_3x4x4"          , percent = 3 },
				{ class = "concrete_wall_3m_2m_white"        , percent = 3 },
				{ class = "concrete_wall_3m_2m_white"        , percent = 3 },
				{ class = "marble_wall_3m_4m"                , percent = 3 }, 
				{ class = "brick_wall_3m_2m_window"          , percent = 3 },
				{ class = "concrete_wall_window_3m_4m_white" , percent = 3 },
				{ class = "plastered_wall_3m_2m_window"      , percent = 3 },
				{ class = "rock_wall_3m_4m"                  , percent = 5 },
				{ class = "plastered_wall_black_3m_2m_window", percent = 7 }, 
				{ class = "plastered_wall_green_3m_4m_door"  , percent = 3 },
				{ class = "plastered_wall_red_3m_4m"         , percent = 3 },
				{ class = "plastered_angled_roof_3x4x4"      , percent = 3 },
				{ class = "classic_platform_3m_4m_4m"        , percent = 3 },
				{ class = "brick_column_3m"                  , percent = 3 },
				...
				{ class = "glass_wall_2m_4m"                 , percent = 5 },
				{ class = "glass_wall_3m_4m"                 , percent = 5 },
				{ class = "one_story_white"                  , percent = 2 },
				{ class = "cabin_wood_black"                 , percent = 1 },
                { class = "cabin_wood_simple"    			 , percent = 1 },
                { class = "cabin_wood_simple"    			 , percent = 1 },
				{ class = "cabin_wood"                       , percent = 1  },
				...
				{ class = "villa_red"						 , percent = 1 },
				{ class = "villa_black"						 , percent = 1 },
				{ class = "villa_white"						 , percent = 1 },
				{ class = "villa_black"						 , percent = 1 },
		...
		-- Air Drops
		{
			...
			classes =
			{
				...
				{ category = "RandomAirDropCrateMilitary"    , percent = 21 },
...

		{
			...
			group =
			{
                ...
                { class = "MotorcycleHelmetSkull"			 , percent = 100                   },
                ...
                { class = "RandomMetalParts"                 , percent = 15  			       },
		...
		
		{
			...
			group =
			{
				...
				{ class = "akval_drummag_75rnd"        , percent = 55 },
                ...
                { class = "SCAAMAmalgarmin", percent = 5}, 
				{ category = "RandomHazmatSuit"        , percent = 50 },
			},
		},
...

		{
			...
			group =
			{
				...
				{ class = "M4A1"                          , percent = 20  },
				{ class = "SheetMetal"                    , percent = 100  , min = 64, max = 128 },
				{ class = "BioFuel"                       , percent = 5    , min = 20, max = 128 },
				{ category = "RandomMetalParts"           , percent = 6   },
				{ category = "RandomMetalParts"           , percent = 3   },
				{ class = "GrenadePickup"                 , percent = 100 },
				{ class = "GrenadePickup"                 , percent = 100 },
		...
		
		{
            ...
            group =
            {
				...
				{ class = "RandomRangedCivilianPure"           , percent = 100  },  
				{ class = "RandomRangedPolicePure"        	   , percent = 100  },  
				{ category = "RandomAmmoBox"                   , percent = 100 },
		...
		
		{
			...
			group =
			{
				...
				{ category = "RandomHazmatSuit", percent = 60 },
		...
		},
		{
			...
			classes =
			{
				{ class = "MxShirtsBlue", percent = 5 },
                { class = "MxPantsBlue", percent = 5 },
                { class = "MxBootsBlue", percent = 5 },
                { class = "MxGlovesBlue", percent = 5 },
                { class = "MxShirtsRed", percent = 5 },
                { class = "MxPantsRed", percent = 5 },
                { class = "MxBootsRed", percent = 5 },
                { class = "MxGlovesRed", percent = 5 },
                { class = "MxShirtsGreen", percent = 5 },
                { class = "MxPantsGreen", percent = 5 },
                ...
                { class = "MxPantsYellow", percent = 5 },
                { class = "MxBootsYellow", percent = 5 },
                { class = "MxGlovesYellow", percent = 5 },
                { class = "MxShirtsPink", percent = 5 },
                { class = "MxPantsPink", percent = 5 },
                { class = "MxBootsPink", percent = 5 },
                { class = "MxGlovesPink", percent = 2 },
                { class = "MxShirtsWhite", percent = 5 },
                { class = "MxPantsWhite", percent = 5 },
                { class = "MxBootsWhite", percent = 5 },
