	...
	itemCategories =
	{
		...
		-- AI
		{
			...
			group =
			{
				...
				{ category = "RandomAmmo"                , percent = 25  },
				{ category = "RandomMedical"             , percent = 75  },
                { category  = "SmallHidingPlaceContent"  , percent = 3   },
                { category  = "RandomConsumable"         , percent = 60   },
                { category  = "RandomBandana"            , percent = 25   },
                { category  = "RandomSneakers"           , percent = 35   },
                { category  = "RandomCivilianHelmet"     , percent = 15   },
                { category  = "RandomBlueJeans2"         , percent = 38   },
			},
		},
...

		{
			...
			classes =
			{
                ...
                { class = "guide_buildextra"                    , percent = 3 },
...

        {
			...
			classes =
			{
				{ class = "farmfence_nz"                , percent = 11.1111 },
				{ class = "postonly_nz"                 , percent = 11.1111 },
				{ class = "Clean_Fence_Mesh_nz"         , percent = 11.1111 },
				{ class = "Clean_Doorway_Mesh_nz"       , percent = 11.1111 },
				{ class = "Broken_Doorway_Mesh_nz"      , percent = 11.1111 },
				{ class = "Left_Clean_Fence_Mesh_nz"    , percent = 11.1111 },
				{ class = "Right_Clean_fence_Mesh_nz"   , percent = 11.1111 },
                { class = "Clean_Door_Mesh_nz"          , percent = 11.1111 },
                { class = "Clean_Fence_Corner_Mesh_nz"  , percent = 11.1111 },
...

		{
			...
			classes =
			{
				{ class = "AmcoinLedger"                    , percent = 5 , min = 20, max = 35 },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomAmmo"                   , percent = 2 , min = 5, max = 15},
...

       {
		...
		
		{
			...
			group =
			{
				...
				{ category = "RandomAmmo"			   , percent = 30   , min = 3, max = 40 },
				{ category = "RandomAmmo"			   , percent = 30   , min = 3, max = 40 },
		...
		
		{
			...
			{
				{ category = "RandomRangedMilitaryPure"       , percent = 100 },
				{ category = "RandomAmmo"                     , percent = 100 , min = 3, max = 40 },
                { category = "RandomAmmo"                     , percent = 100 , min = 3, max = 40 },
                { category = "RandomAmmo"                     , percent = 100 , min = 3, max = 40 },
                { category = "RandomAmmo"                     , percent = 100 , min = 3, max = 40 },
                { category = "RandomCargador"                 , percent = 100 },
				...
				{ category = "RandomAllHazmatMask"            , percent = 100 },
				{ category = "RandomAllGasCanisterPack"       , percent = 100 },
				{ class = "AntiradiationPills"                , percent = 80  , min = 1, max = 9  },
				...
				{ category = "RandomAmmo"                     , percent = 60 , min = 3, max = 9},
				{ category = "RandomEpicWeaponPure"           , percent = 20 },
		...
		
		{
			...
			group =
			{
                ...
                { category = "RandomAmmo"              , percent = 100  , min = 20, max = 50   },
				{ category = "RandomAmmo"              , percent = 100  , min = 20, max = 50   },
				...
				{ category = "RandomAmmo"              , percent = 100  , min = 20, max = 100  },
                { category = "RandomAmmo"              , percent = 100  , min = 20, max = 100  },
                { category = "RandomAmmo"              , percent = 100  , min = 20, max = 100  },
                { category = "RandomAmmo"              , percent = 100  , min = 20, max = 100  },
				...
				{ category = "RandomAmmo"              , percent = 60   , min = 10, max = 58 },
		...
		
		{
			...
			group =
			{
                ...
                { category = "RandomAmmo"               , percent = 100  , min = 30, max = 128},
                { category = "RandomAmmo"               , percent = 100  , min = 30, max = 128},
                { category = "RandomAmmo"               , percent = 100  , min = 30, max = 128},
                { category = "RandomAmmo"               , percent = 100  , min = 30, max = 128},
...

		{
			...
			group =
			{
				...
				{ category = "RandomMetalParts"           , percent = 3   },
				{ category = "RandomAmmo"                 , percent = 60  , min = 12, max = 48},
				{ category = "RandomAmmo"                 , percent = 60  , min = 12, max = 48 },
                { category = "RandomAmmo"                 , percent = 60  , min = 12, max = 48 },
		...
		
		{
            ...
            group =
            {
                ...
                { class = "SAPOCBriefcaseClosed"                , percent = 70   },
                { category = "EventHelmets"                     , percent = 5    },
                { category = "RandomSkullGear"    			    , percent = 10 	 },
