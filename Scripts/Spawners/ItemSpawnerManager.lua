	...
	itemCategories =
	{
		...
		
		{
			...
			classes =
			{
				...
				{ class = "ScavengerHelmet"          , percent = 20 },
		...
		
		{
			...
			group =
			{
                ...
                { class = "SpartanHelmet"                    , percent = 70  },
		...
		
		{
            ...
            group =
            {
                ...
                { category = "RandomIronSuite"				   , percent = 100  },
                { category = "RandomTron"     				   , percent = 100 	},
                { category = "RandomAmmoBox"  				   , percent = 100 	},
                { category = "RandomSilencer" 				   , percent = 100   , min = 1, max = 1 },
                { category = "RandomAmmoBox"  				   , percent = 100 	},
                { category = "RandomAmmoBox"  				   , percent = 100 	},
                ...
                { class = "AssaultHelmet"       			   , percent = 50 	},
                { category = "RandomSkullGear"    			   , percent = 30 	},
