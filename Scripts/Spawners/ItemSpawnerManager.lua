	...
	itemCategories =
	{
...

		{
			...
			classes =
			{
				...
				{ class = "PSOScope"               , percent = 1  },
				{ class = "ext_762x30"             , percent = 3  },
				{ class = "ext_556x75"             , percent = 5  },
				{ class = "ext_762x75"             , percent = 1  },
				{ class = "STANAGx50"              , percent = 5  },
