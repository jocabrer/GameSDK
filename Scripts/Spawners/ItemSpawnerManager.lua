	...
	itemCategories =
	{
		...
		-- AI
		{
			...
			group =
			{
                ...
                { category  = "MediumHidingPlaceContent" , percent = 1   },
			},
		},
...

		{
			...
			group =
			{
                ...
                { category  = "RandomConsumable"        , percent = 90   },
			},
		},
		...
		},
		{
			...
			classes =
			{
                { class = "Arrowx8"              , percent = 6.4666  },
                { class = "Boltx5_0000"          , percent = 6.4666  },
                { class = "Pile_10mm"            , percent = 6.4666  },
                { class = "Pile_22"              , percent = 6.4666  },
                { class = "Pile_545x39"          , percent = 6.4666  },
                { class = "Pile_57x28"           , percent = 6.4666  },
                { class = "Pile_223"             , percent = 6.4666  },
                { class = "Pile_308"             , percent = 6.4666  },
                { class = "Pile_357"             , percent = 6.4666  },
                { class = "Pile_45ACP"           , percent = 6.4666  },
                { class = "Pile_556x45"          , percent = 6.4666  },
                { class = "Pile_762x39"          , percent = 6.4666  },
                { class = "Pile_762x51"          , percent = 6.4666  },
                { class = "Pile_9mm"             , percent = 6.4666  },
                { class = "Pile_Flare"           , percent = 6.4666  },
...

		{
			...
			classes =
			{
				...
				{ class = "RK_Sledgehammer"              , percent = 1.5 },
				{ class = "Icepickaxe"                   , percent = 0.5 },
