...
--]]
	...
	itemCategories =
	{
...

        {
			...
			classes =
			{
				{ class = "ext_762x30"             , percent = 11.1  },
				{ class = "ext_556x75"             , percent = 11.1  },
				{ class = "ext_762x75"             , percent = 11.1  },
				{ class = "STANAGx50"              , percent = 11.1  },
				{ class = "akval_drummag_75rnd"	   , percent = 11.1  },
                { class = "762x30"	   			   , percent = 11.1  },
                { class = "STANAGx30"	   		   , percent = 11.1  },
                { class = "545x30"	   			   , percent = 11.1  },
                { class = "57x60"	   			   , percent = 11.1  },
			},
		},
		...
		
		{
            ...
            group =
            {
				...
				{ category = "RandomMilitaryArmor"              , percent = 100  },
                { category = "RandomAmmoBox"                    , percent = 100  },
				{ class 	= "AmcoinLedger"                    , percent = 100   , min = 50, max = 200 },
                { class 	= "AmcoinLedger"                    , percent = 100   , min = 50, max = 200 },
                { category = "RandomAmmoBox"  				    , percent = 100  },
                { category = "RandomSilencer" 				    , percent = 100   , min = 1, max = 1 },
                { category = "RandomAmmoBox"  				    , percent = 100  },
                ...
                { category = "EventHelmets"                     , percent = 50   },
                { class = "Pile_40mmGrenade"                    , percent = 50    , min = 1, max = 5  },
