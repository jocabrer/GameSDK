	...
	itemCategories =
	{
		...
		
		{
			...
			classes =
			{
				...
				{ class = "camping_lantern"                   , percent = 7 },
                { class = "camping_lantern_pink"  			  , percent = 7 },
                { class = "camping_lantern_red"   			  , percent = 7 },
                { class = "camping_lantern_aqua"  			  , percent = 7 },
                { class = "camping_lantern_blue"  			  , percent = 7 },
				...
				{ class = "camping_pop_up_canopy"             , percent = 4 },
				{ class = "camping_table"                     , percent = 4 },
				{ class = "camping_water_jug"                 , percent = 5 },
				{ class = "RandomHuntingItems"                , percent = 8 },
				{ category = "RandomTent"                     , percent = 4 },
			},
		},
