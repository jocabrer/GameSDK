	...
	itemCategories =
	{
		...
		
		{
			...
			classes =
			{
				...
				{ class = "SkullMaskGold"                , percent = 6   },
				{ category = "RandomEpicAttachmentTrader", percent = 6   },
				{ class = "AK5D"                         , percent = 6   },
				{ category = "RandomEpicWeaponTrader"    , percent = 1.5 },
				{ class = "SpaceHelmet"                  , percent = 1.5 },
				{ class = "wood_coffin"                  , percent = 1.5 },
...

		{
			...
			classes =
			{
				...
				{ class = "R3Sight"                , percent = 4  },
				{ class = "PSOScope"               , percent = 2  },
				{ class = "ext_762x30"             , percent = 4  },
				{ class = "ext_556x75"             , percent = 6  },
				{ class = "ext_762x75"             , percent = 3  },
				{ class = "STANAGx50"              , percent = 3  },
				{ class = "HuntingScope"		   , percent = 2  },
				{ class = "OpticScope"		   	   , percent = 3  },
		...
		},
		{
			...
			classes =
			{
                ...
                { class = "Pile_556x45"          , percent = 5                     },
                { class = "Pile_762x39"          , percent = 5                     },
                { class = "Pile_762x51"          , percent = 4                     },
                { class = "Pile_9mm"             , percent = 2                     },
...

		{
			...
			classes =
			{
				...
				{ class = "AmmoBox_357"     , percent = 5   , min = 50, max = 100 },
				{ class = "AmmoBox_223"     , percent = 5   , min = 50, max = 100 },
				{ class = "AmmoBox_5_45x39" , percent = 8   , min = 50, max = 100 },
				{ class = "AmmoBox_5_56x45" , percent = 8   , min = 50, max = 100 },
				{ class = "AmmoBox_5_70x28" , percent = 8   , min = 50, max = 100 },
				{ class = "AmmoBox_7_62x39" , percent = 8   , min = 50, max = 100 },
				{ class = "AmmoBox_7_62x51" , percent = 8   , min = 50, max = 100 },
