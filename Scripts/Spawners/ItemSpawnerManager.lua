	...
	itemCategories =
	{
...

		{
			...
			group =
			{
				...
				{ category = "RandomConsumable"         , percent = 45   },
                { category = "RandomMedical"            , percent = 50  },
				{ category = "RandomAmmo"               , percent = 20    , min = 1, max = 1   },
                { category = "RandomCargador"           , percent = 35    , min = 10, max = 25 },
				{ category  = "RandomBackpackContents"  , percent = 30   }, 
                { class  = "SAPOCBriefcaseClosed"       , percent = 1    , min = 1, max = 1     },
                { category  = "RandomConsumable"        , percent = 20   },
                { category  = "RandomClothes"           , percent = 25   },
			},
		},
		...
		
		{
			...
			group =
			{
				...
				{ category = "RandomCargador"          , percent = 100 , min = 25, max = 50},
                { category = "RandomCargador"          , percent = 100 , min = 25, max = 50},
                { category = "RandomCargador"          , percent = 100 , min = 25, max = 50},
                { category = "RandomCargador"          , percent = 100 , min = 25, max = 50},
				...
				{ category = "RandomAmmo"              , percent = 100  , min = 1, max = 1 },
                { category = "RandomEpicWeapon"        , percent = 25  },
                { category = "RandomEpicWeapon"        , percent = 25  },
                { category = "RandomEpicWeapon"        , percent = 25  },
                { category = "RandomEpicWeapon"        , percent = 25  },
                ...
                { category = "RandomEpicWeapon"        , percent = 25  },
                { category = "RandomEpicWeaponPure"    , percent = 25  },
                { category = "RandomTshirt"            , percent = 55  },
				{ class = "SAPOCBriefcaseClosed"       , percent = 2   , min = 1, max = 1     },
		...
		
		{
			...
			group =
			{
				...
				{ category = "RandomAllHazmatMask"            , percent = 100 },
				{ category = "RandomAllGasCanisterPack"       , percent = 100 },
				{ class = "AntiradiationPills"                , percent = 90  , min = 1, max = 9  },
				{ class = "MushroomAntiRad"                   , percent = 75  , min = 1, max = 5  },
				{ class = "PotassiumIodidePills"              , percent = 60  , min = 3, max = 3  },
                { category = "RandomMedical"                  , percent = 100 },
				{ class = "AntibioticBandage"                 , percent = 100  , min = 3, max = 9  },
				{ category = "RandomDrink"                    , percent = 100 },
				{ category = "RandomMedical"                  , percent = 100  , min = 3, max = 3  },
				{ category = "RandomAmmo"                     , percent = 100 , min = 1, max = 1 },
                { category = "RandomAmmo"                     , percent = 100 , min = 1, max = 1 },
				...
				{ category = "RandomEpicWeaponPure"           , percent = 20 },
				{ category = "RandomAmmo"                     , percent = 60 , min = 1, max = 1},
				{ category = "RandomEpicWeaponPure"           , percent = 60 },
                ...
                { category = "RandomTron"         			  , percent = 5 },
                { category = "RandomPoliceItems"    		  , percent = 25 },
		...
		
		{
			...
			group =
			{
                ...
                { class = "IronIngot"                      , percent = 100, min = 12, max = 36 },
				{ class = "Nails"                          , percent = 80,  min = 12, max = 80 },
                { class = "Nails"                          , percent = 100, min = 12, max = 80 },
                { class = "ScrapMetal"         			   , percent = 100,  min = 10 , max = 70 },
                { category = "RandomMetalParts"			   , percent = 100 },
				{ category = "RandomMetalParts"            , percent = 100 },
				{ category = "RandomMetalParts"            , percent = 100 },
                { category = "RandomPainting"              , percent = 95  },
                { category = "RandomMetalParts"            , percent = 100 },
                { category = "RandomMetalParts"            , percent = 50  },
				{ class = "ConcreteBag"                    , percent = 100  , min = 3, max = 50 },
                { class = "ConcreteBag"       			   , percent = 20   , min = 3, max = 10 },
                { class = "ConcreteBag"       			   , percent = 50   , min = 3, max = 10 },
				{ category = "RandomPaintCan"              , percent = 80  },
                { category = "RandomPaintCan"              , percent = 85  },
                { category = "RandomGlassParts"            , percent = 90  },
                { class = "UFOStorage_Crate_packed"        , percent = 2   },
                { category = "RandomMonumento"             , percent = 0.5 },
                { class = "SCAAMCCTVCamera"                , percent = 20  },
				{ class = "WorkLight"                      , percent = 50   ,min = 1, max = 10 },              
                ...
                { category = "RandomCrafting"              , percent = 100  },
				{ category = "RandomLightColumn"           , percent = 10  },
				{ class = "Icepickaxe"                     , percent = 5   },
                { class = "Pickaxe"                        , percent = 45  },
                { class = "Hammer"                         , percent = 25  },
                { class = "Hammer"                         , percent = 25  },
                { class = "guide_buildextra"               , percent = 6   },
			},
		},
		
		{
			...
			group =
			{
                { category = "RandomMedical"	       , percent = 50   , min = 1 , max = 10   },
                { category = "RandomAmmo"              , percent = 100  , min = 1 , max = 1    },
				{ category = "RandomAmmo"              , percent = 100  , min = 1 , max = 1    },
				{ category = "RandomAmmo"              , percent = 100  , min = 1 , max = 1  },
                { category = "RandomAmmo"              , percent = 100  , min = 1 , max = 1  },
				...
				{ category = "RandomAmmoBox"           , percent = 45 },
				...
				{ class = "AmcoinLedger"               , percent = 25   , min = 1, max = 255 },
				
                { category = "RandomCargador"          , percent = 100 },
                { category = "RandomCargador"          , percent = 60  },
				{ category = "RandomRangedPure"        , percent = 95  },
                { class = "SCAAMAmalgarmin"			   , percent = 35  }, 
		...
		
		{
			...
			group =
			{
				...
				{ category = "RandomLantern"                 , percent = 100  },
				{ category = "RandomFood"                    , percent = 100 },
				{ category = "RandomFood"                    , percent = 100 },
				{ category = "SmallHidingPlaceContent"       , percent = 100 },
				{ category = "SmallHidingPlaceContent"       , percent = 100 },
				{ category = "RandomTent"	                 , percent = 100  , min = 5, max = 25    },
				
                { category = "RandomAmmoBox"                 , percent = 80  },
                ...
                { category = "EventHelmets"                  , percent = 10  },
                { category = "RandomTron"                    , percent = 10  },
                { category = "RandomAllGasCanisterPack"      , percent = 50  },
                { category = "RandomFlashlight"              , percent = 80  },
		...
		
		{
			...
			group =
			{
                { class = "Gunpowder"                   , percent = 100  , min = 1, max = 250  },
				{ class = "Gunpowder"                   , percent = 100  , min = 1, max = 250  },
                ...
                { category = "RandomMedical"	        , percent = 100  , min = 1, max = 10    },
                { category = "RandomMedical"	        , percent = 100  , min = 1, max = 10    },
				{ category = "RandomMedical"	        , percent = 100  , min = 1, max = 3    },
				{ category = "RandomChemlight"	        , percent = 100  , min = 1, max = 25    },
				{ category = "RandomMushroom"	        , percent = 100  , min = 5, max = 25    },
				



				{ category = "RandomMaintenance"        , percent = 50   },
				{ category = "EventHelmets"             , percent = 50   },
				{ category = "RandomSmokeGrenade"       , percent = 50   , min = 1, max = 5     },
			
				{ category = "RandomEpicWeapon"         , percent = 90  },
				{ category = "RandomCargador"           , percent = 80   },
				{ category = "RandomEpicWeapon"         , percent = 90   },
                { category = "RandomFlashlight"         , percent = 90   },
                
                { category = "RandomMilitaryItems"      , percent = 45  },
                { category = "RandomAlcohol"            , percent = 45  },
                { category = "RandomAllHazmatMask"      , percent = 45  },
                { category = "RandomIronSuite"          , percent = 45  },
                { category = "RandomAllHazmatMask"      , percent = 45  },
                ...
                { category = "RandomSilencer"	        , percent = 25  , min = 1, max = 1     },
                { category = "RandomSilencer"	        , percent = 25  , min = 1, max = 1     },
