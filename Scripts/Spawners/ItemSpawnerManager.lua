	...
	itemCategories =
	{
...

		{
			...
			classes =
			{
				...
				-- basic (34) 
				{ class = "guide_structures_wood_bridges_1"     , percent = 3.4  },
				{ class = "guide_structures_wood_ramps_1"       , percent = 3.4  },
				{ class = "guide_structures_wood_stairs_1"      , percent = 3.4  },
				{ class = "guide_structures_wood_traps_1"       , percent = 3.4  },
				{ class = "guide_structures_wood_walkways_1"    , percent = 3.4  },
				{ class = "guide_structures_wood_walls_1"       , percent = 3.4  },
				{ class = "guide_structures_wood_roofs"         , percent = 3.4  },
				{ class = "guide_powered_parts_1"               , percent = 3.4  },
				{ class = "guide_traps_1"                       , percent = 3.4  },
				{ class = "guide_weapons_ranged_1"              , percent = 3.4  },
 
				-- advanced (38)
				{ class = "guide_structures_wood_bridges_2"     , percent = 3.45 },
				{ class = "guide_structures_wood_ramps_2"       , percent = 3.45 },
				{ class = "guide_structures_wood_stairs_2"      , percent = 3.45 },
				{ class = "guide_structures_wood_traps_2"       , percent = 3.45 },
				{ class = "guide_structures_wood_walkways_2"    , percent = 3.45 },
				{ class = "guide_structures_wood_walls_2"       , percent = 3.45 },
				{ class = "guide_traps_2"                       , percent = 3.45 },
				{ class = "guide_weapons_ranged_2"              , percent = 3.45 },
				{ class = "guide_weapons_ranged_3"              , percent = 3.45 },
                { class = "guide_buildextra"                    , percent = 3.5  },
                { class = "guide_concrete"                      , percent = 3.45 },
