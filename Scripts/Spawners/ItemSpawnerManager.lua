...
--]]
	...
	itemCategories =
	{
...

		{
			...
			group =
			{
				{ category  = "RandomAmmo",               percent = 60   , min = 1, max = 15},
                { category  = "RandomAmmo",               percent = 40   , min = 1, max = 15},
                { category  = "RandomAmmo",               percent = 50   , min = 1, max = 15},
				{ category  = "RandomMushroom",           percent = 50   },
				{ class     = "AmcoinLedger",             percent = 30   , min = 1, max = 25 },
		...
		},
		{
			...
			classes =
			{
                ...
                { class = "Pile_22"              , percent = 5.88    , min = 1, max = 25 },
                { class = "Pile_545x39"          , percent = 5.88    , min = 1, max = 25 },
                { class = "Pile_57x28"           , percent = 5.88    , min = 1, max = 25 },
                { class = "Pile_223"             , percent = 5.88    , min = 1, max = 25 },
                { class = "Pile_308"             , percent = 5.88    , min = 1, max = 25 },
                { class = "Pile_357"             , percent = 5.88    , min = 1, max = 25 },
                { class = "Pile_45ACP"           , percent = 5.88    , min = 1, max = 25 },
                { class = "Pile_556x45"          , percent = 5.88    , min = 1, max = 25 },
                { class = "Pile_762x39"          , percent = 5.88    , min = 1, max = 25 },
                { class = "Pile_762x51"          , percent = 5.88    , min = 1, max = 25 },
...

		{
			...
			classes =
			{
				...
				{ class = "Icepickaxe"                   , percent = 0.5 },
                { category = "RandomCraftingGuide" 		 , percent = 7.5 },
