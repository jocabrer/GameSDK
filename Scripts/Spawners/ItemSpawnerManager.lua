	...
	itemCategories =
	{
		...
		
		{
			...
			group =
			{
                ...
                { category = "RandomTron"                    , percent = 80  },
                { category = "RandomAllGasCanisterPack"      , percent = 80  },
                { class = "GoldenCudgel"                     , percent = 30  },
		...
		
		{
            ...
            group =
            {
				...
				{ class = "SCAAMAmalgarmin"                    , percent = 25	},
				{ class = "GoldenCudgel"         			   , percent = 50  	}, 
				{ class = "GoldenCudgel2"        			   , percent = 50  	},  
				...
				{ class = "PlasmaRifle"			   		       , percent = 5 	},
				{ class = "RocketLauncherNew"			       , percent = 15 	},
				{ category = "RandomRocket"			   		   , percent = 15 	 , min = 10, max = 40 },
				{ category = "RandomRocket"		   	   		   , percent = 25	 , min = 3, max = 5 },
                { class = "SAPOCBriefcaseClosed"               , percent = 30   },
                { category = "EventHelmets"                    , percent = 5   },
                { class = "AssaultHelmet"       			   , percent = 5 	},
                { category = "RandomSkullGear"    			   , percent = 5 	},
