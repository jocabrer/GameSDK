	...
	itemCategories =
	{
...

		{
			...
			classes =
			{
				...
				{ category = "RandomPoliceHelmet"           , percent = 25  },
		...
		-- Back
		{
			...
			classes =
			{
				...
				{ category = "RandomGasCanisterPackColored"    , percent = 10 },
		...
		-- largly based on random ranged weapon, rest from crafted
		{
			...
			classes =
			{
				...
				{ class = "RK_Handguns"       , percent = 5   },
				{ class = "RK_Shotguns"       , percent = 9   },
				{ class = "RK_SubMachineguns" , percent = 11  },
				{ class = "RK_AssaultRifles"  , percent = 11  },
		...
		-- Custom Metal Parts
		{
			...
			classes =
			{
                ...
                { class = "base_modern_family_door"          , percent = 2    , min = 1, max = 2 },
                ...
                { class = "marble_wall_black_3m_4m"          , percent = 1    , min = 1, max = 2 },
                { class = "marble_platform_3m_4m_4m_stairs"  , percent = 1    , min = 1, max = 2 },
                { class = "rock_wall_window_3m_2m_beamless"  , percent = 2    , min = 1, max = 2 },
		...
		
		{
			...
			group =
			{
				...
				{ category = "RandomPoliceHelmet"      , percent = 50 },
		...
		
		{
			...
			group =
			{
				...
				{ class = "BioFuel"                    , percent = 80, min = 40, max = 128 },
		...
		
		{
            ...
            group =
            {
				...
				{ category = "RandomSpartaGear"           	   , percent = 28 	},
				...
				{ category = "RandomPlasma"			   		   , percent = 50 	 , min = 3, max = 40 },
				{ category = "PlasmaRifle"			   		   , percent = 50 	},
				{ category = "PlasmaRifle"			   		   , percent = 50 	},
				{ category = "RocketLauncherNew"			   , percent = 3 	},
