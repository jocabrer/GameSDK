	...
	itemCategories =
	{
		...
		-- Custom Metal Parts
		{
			...
			classes =
			{
                ...
                { category = "RandomPlastered"                       , percent = 2    },
                { category = "RandomConcrete"                        , percent = 2    },
                { category = "RandomPrefab"	    		             , percent = 2    },
                { category = "RandomGlassParts"   		             , percent = 2    },
                { category = "RandomTitanium"   		             , percent = 1    },
                { category = "RandomMarmol"       		             , percent = 2    },
                { category = "RandomTent"       		             , percent = 2    },
                { class = "brick_angled_roof_3x4x4"                  , percent = 2.3    },
				{ class = "marble_wall_3m_4m"                        , percent = 2.3    }, 
				{ class = "brick_wall_3m_2m_window"                  , percent = 2.3    },
				{ class = "rock_wall_3m_4m"                          , percent = 2.3    },
				{ class = "classic_platform_3m_4m_4m"                , percent = 2.3    },
				{ class = "brick_column_3m"                          , percent = 2.3    },
				{ class = "brick_wall_3m_2m"                         , percent = 2.3    },
				{ class = "cobblestone_column_3m"                    , percent = 2.3    },
				{ class = "cobblestone_platform_3m_4m_4m"            , percent = 2.3    },
				{ class = "brick_wall_3m_4m_door"                    , percent = 2.3    },
				{ class = "rock_doorway_3m_4m"                       , percent = 2.3    },
				{ class = "brick_wall_3m_4m"                         , percent = 2.3    , min = 2, max = 5 },
                { class = "Left_Clean_Fence_Mesh_nz"   		         , percent = 2.3    },
                { class = "Right_Clean_fence_Mesh_nz"   	         , percent = 2.3    },
                { class = "postonly_nz"   		                     , percent = 2.3    },
                { class = "6mx6m_corrugated_metal_02"                , percent = 2.3    },
                { class = "marble_wall_green_3m_4m"                  , percent = 2.3    , min = 1, max = 2 },
                { class = "marble_platform_green_3m_8m_8m"           , percent = 2.3    , min = 1, max = 2 },
                { class = "marble_column_3m_black"                   , percent = 2.3    , min = 1, max = 2 },
                { class = "marble_ceiling_4m_4m_blue"                , percent = 2.3    , min = 1, max = 2 },
                { class = "marble_ceiling_8m_8m_black"               , percent = 2.3    , min = 1, max = 2 },
                { class = "base_24store_door"                        , percent = 2.3    , min = 1, max = 2 },
                { class = "base_modern_family_door"                  , percent = 2.3    , min = 1, max = 2 },
                { class = "garage_gate_6m_4m"                        , percent = 2.3    },
                { class = "Gateframe_6m_4m"                          , percent = 2.3    },
                { class = "Gateframe_6m_8m"                          , percent = 2.3    },
                { class = "garage_gate_6m_8m"                        , percent = 2.3    },
                { class = "marble_foundation_black_4m_4m_4m"         , percent = 2.3    , min = 1, max = 2 },
                { class = "marble_wall_3m_2m_window"                 , percent = 2.3    , min = 1, max = 2 },
                { class = "marble_wall_black_3m_4m"                  , percent = 2.3    , min = 1, max = 2 },
                { class = "marble_platform_3m_4m_4m_stairs"          , percent = 2.3    , min = 1, max = 2 },
                { class = "rock_wall_window_3m_2m_beamless"          , percent = 2.3    , min = 1, max = 2 },
                { class = "rock_wall_4m_4m"                          , percent = 2.3    , min = 1, max = 2 },
                { class = "cobblestone_wall_3m_2m"                   , percent = 2.3    , min = 1, max = 2 },
				{ class = "round_platform_conctete_0x8_gold"         , percent = 2.3    , min = 1, max = 2 },
			},
		},
        {
		...
		},
        {
			...
			classes =
			{
				{ category = "glass_doorway_3m_2m"       , percent = 3.12 },
				{ category = "glass_doorway_3m_4m"       , percent = 3.12 },
				{ category = "glass_doorway_3m_4m_side"  , percent = 3.12 },
                { category = "glass_doorway_3m_4m_v2"    , percent = 3.12 },
                { category = "glass_doorway_3m_8m"       , percent = 3.12 },
                { category = "glass_wall_1_3m_2m"        , percent = 3.12 },
                { category = "glass_wall_1_3m_4m"        , percent = 3.12 },
                { category = "glass_wall_1_3m_8m"        , percent = 3.12 },
                { category = "glass_wall_1_3m_12m"       , percent = 3.12 },
                { category = "glass_wall_1_3m_16m"       , percent = 3.12 },
                { category = "glass_wall_2m_2m"          , percent = 3.12 },
                { category = "glass_wall_2m_4m"          , percent = 3.12 },
                { category = "glass_wall_2m_8m"          , percent = 3.12 },
                { category = "glass_wall_2m_12m"         , percent = 3.12 },
                { category = "glass_wall_2m_16m"         , percent = 3.12 },
                { category = "glass_wall_3m_2m"          , percent = 3.12 },
                { category = "glass_wall_3m_4m"          , percent = 3.12 },
                { category = "glass_wall_3m_8m"          , percent = 3.12 },
                { category = "glass_wall_3m_12m"         , percent = 3.12 },
                { category = "glass_wall_3m_16m"         , percent = 3.12 },
                { category = "glass_door_2m_1m"          , percent = 3.12 },
                { category = "glass_door_3m_2m"          , percent = 3.12 },
                { category = "window"                    , percent = 3.12 },
                { category = "door_glass_white"          , percent = 3.12 },
                { category = "Glass_Platform_HMS_3x16x16", percent = 3.12 },
                { category = "Glass_Platform_HMS_3x12x12", percent = 3.12 },
                { category = "Glass_Platform_HMS_3x8x8"  , percent = 3.12 },
                { category = "Glass_Platform_HMS_3x4x4"  , percent = 3.12 },
                { category = "Glass_Platform_HMS_0x16x16", percent = 3.12 },
                { category = "Glass_Platform_HMS_0x12x12", percent = 3.12 },
                { category = "Glass_Platform_HMS_0x8x8"  , percent = 3.12 },
                { category = "Glass_Platform_HMS_0x4x4"  , percent = 3.12 },
			},
		},
        {
		...
		
		{
			...
			group =
			{
                ...
                { class = "IronOre"                        , percent = 100, min = 12, max = 36 },
				{ class = "WoodPile"                       , percent = 100, min = 12, max = 36 },
				{ class = "Pyrite"                         , percent = 100, min = 12, max = 36 },
				{ class = "Rocks"                          , percent = 100, min = 12, max = 36 },
				{ class = "Nails"                          , percent = 100, min = 12, max = 36 },
				{ class = "ScrapMetal"                     , percent = 100, min = 12, max = 36 },
                { class = "ScrapMetal"         			   , percent = 100, min = 12, max = 36 },
				{ class = "ScrapMetal"         			   , percent = 100, min = 12, max = 36 },
				...
				{ category = "RandomMetalParts"            , percent = 100 },
                { category = "RandomMetalParts"            , percent = 100 },
				{ class = "ConcreteBag"                    , percent = 100  , min = 1, max = 15 },
                { class = "ConcreteBag"       			   , percent = 100  , min = 1, max = 15 },
                { class = "ConcreteBag"       			   , percent = 50   , min = 1, max = 15 },
