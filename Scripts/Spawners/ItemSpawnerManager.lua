	...
	itemCategories =
	{
		...
		},
		{
			...
			classes =
			{
                ...
                { category = "RandomAccessory"   , percent = 5     },
				{ category = "RandomPlasma"      , percent = 1     , min = 3, max = 15 },
                { class = "9mmx10_makarov"       , percent = 1     },
                { class = "9mmx15_m9a1"          , percent = 1     },
                ...
                { class = "Pile_762x39"          , percent = 3.5   },
                { class = "Pile_762x51"          , percent = 3.5   },
                { class = "Pile_9mm"             , percent = 2.5   },
                { class = "Pile_Flare"           , percent = 0.5   },
                { class = "STANAGx30"            , percent = 3     },
                { class = "STANAGx50"            , percent = 1     },
                { class = "762x40"               , percent = 2     },
                { class = "guide_ammunition"     , percent = 0.5   },
                { class = "BioFuel"              , percent = 1     , min = 20, max = 40 },
                ...
                { class = "SalazarSkull"         , percent = 0.4   },
                { class = "556x100"              , percent = 1.4   },
                { class = "556x100"              , percent = 1.4   },
				{ category = "RandomRocket"      , percent = 0.5   },
		...
		-- Custom Metal Parts
		{
			...
			classes =
			{
                ...
                { class = "light_tower_tall"   		                 , percent = 1      },
                ...
                { class = "Gateframe_6m_8m"                          , percent = 2       },
		...
		
		{
			...
			group =
			{
                ...
                { class = "MotorcycleHelmetSkull" 			  , percent = 80 },
		...
		
		{
			...
			group =
			{
                ...
                { class = "Pyrite"             			   , percent = 100, min = 64, max = 128 },
                { class = "Charcoal"           			   , percent = 100, min = 64, max = 128 },
                { class = "Charcoal"           			   , percent = 100, min = 64, max = 128 },
		...
		
		{
			...
			group =
			{
				...
				{ class = "AnimalFat"                        , percent = 20, min = 20, max = 64 },
				{ category = "RandomAccessory"               , percent = 100 },
				...
				{ category = "RandomLantern"                 , percent = 80  },
                ...
                { class = "SCAAMAmalgarmin"			         , percent = 5   }, 
				{ category = "RandomAllHazmatSuit"           , percent = 50  },
				{ category = "RandomPlasma"		   	         , percent = 70, min = 3, max = 58 },
				{ category = "RandomRocket"		   	         , percent = 15, min = 3, max = 10 },
			},
		},
		
		{
			...
			group =
			{
				...
				{ class = "GrenadePickup"        , percent = 80  },
				{ class = "Pile_40mmGrenade"     , percent = 5, min = 1, max = 5 },
				...
				{ class = "M97"                  , percent = 20 },
				{ class = "M97"                  , percent = 15 },
				{ class = "PlasmaRifle"          , percent = 25 },
				...
				{ category = "RandomRocket"      , percent = 5  , min = 1, max = 10},
				{ category = "RandomRocket"      , percent = 5  , min = 1, max = 10},
				{ category = "RandomRocket"      , percent = 5  , min = 1, max = 10},
