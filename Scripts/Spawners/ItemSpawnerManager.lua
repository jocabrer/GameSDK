	...
	itemCategories =
	{
		...
		-- Custom Metal Parts
		{
			...
			classes =
			{
				...
				{ class = "concrete_wall_3m_2m_white"        , percent = 3   },
				{ class = "marble_wall_3m_4m"                , percent = 4   }, 
				{ class = "brick_wall_3m_2m_window"          , percent = 2   },
				{ class = "concrete_wall_window_3m_4m_white" , percent = 4   },
				{ class = "plastered_wall_3m_2m_window"      , percent = 4   },
				{ class = "rock_wall_3m_4m"                  , percent = 3   },
				...
				{ category = "RandomPrefab"	    		     , percent = 10   },
