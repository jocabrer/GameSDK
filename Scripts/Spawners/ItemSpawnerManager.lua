...
--]]
	...
	itemCategories =
	{
		...
		-- Air Drops
		{
			...
			classes =
			{
				{ category = "RandomAirDropCratePolice"         , percent = 5   },
				{ category = "RandomAirDropCrateMilitary"       , percent = 5   },
				{ category = "RandomAirDropCrateCivilian"       , percent = 40  },
				{ category = "RandomAirDropCrateExplosives"     , percent = 5   },
				{ category = "RandomAirDropCrateBaseBuilding"   , percent = 40  },
				{ category = "RandomAirDropCrateRadiation"      , percent = 5   },
			},
		},

		{
			...
			group =
			{
				...
				{ category = "RandomRangedMilitaryPure"      , percent = 100 				   },
				{ category = "RandomRangedMilitaryPure"      , percent = 100 				   },
				{ class = "AmcoinLedger"                     , percent = 1, min = 30, max = 125},
		...
		
		{
			...
			group =
			{
                ...
                { class = "guide_buildextra"               , percent = 15  },
		...
		
		{
			...
			group =
			{
                ...
                { class = "GrenadePickup"               , percent = 25   , min = 1, max = 5     },
                { class = "GrenadePickup"               , percent = 35   , min = 1, max = 5     },
                { class = "GrenadePickup"               , percent = 45   , min = 1, max = 5     },
                { class = "Amalgaduino"                 , percent = 60   , min = 1, max = 15    },
                { class = "Pile_40mmGrenade"            , percent = 80   , min = 1, max = 5     },
