...
--]]
	...
	itemCategories =
	{
...

        {
			...
			classes =
			{
				{ class = "ext_762x30"             , percent = 9.09, min = 9, max = 30  },
				{ class = "ext_556x75"             , percent = 9.09, min = 9, max = 75  },
				{ class = "ext_762x75"             , percent = 9.09, min = 9, max = 75  },
				{ class = "STANAGx50"              , percent = 9.09, min = 9, max = 10  },
				{ class = "akval_drummag_75rnd"	   , percent = 9.09, min = 9, max = 75  },
                { class = "762x30"	   			   , percent = 9.09, min = 9, max = 10  },
                { class = "STANAGx30"	   		   , percent = 9.09, min = 9, max = 30  },
                { class = "545x30"	   			   , percent = 9.09, min = 9, max = 30  },
                { class = "57x60"	   			   , percent = 9.09, min = 9, max = 60  },
                { class = "g36cx50"	   			   , percent = 9.09, min = 9, max = 50  },
                { class = "g36c_mag"   			   , percent = 9.09, min = 9, max = 20  },
			},
		},
