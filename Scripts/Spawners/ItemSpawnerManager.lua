...
--]]
	...
	itemCategories =
	{
		...
		-- A random epic spawn for hard to reach areas. Use sparingly.
		{
			...
			classes =
			{
				{ category = "Mk18ReaverWithMagazines"       , percent = 15   },
				...
				{ class = "RocketLauncherNew"			  	 , percent = 3   },
...

		{
			...
			classes =
			{
				...
				{class = "Wheel"                , percent = 20   , min = 4, max = 4 },
...

		{
			...
			classes =
			{
                ...
                {class    = "Wheel"              , percent =  10 , min = 6, max = 6 },
                {class    = "Oil"                , percent =  14 },
...

		{
			...
			classes =
			{
				...
				{class = "Wheel", percent = 15, min = 4, max = 4 },
				{class = "Oil", percent = 5 },
				{class = "JerryCanDiesel", percent = 5 },
			},
		},
...

		{
			...
			group =
			{
				...
				{ class = "BearPelt" },
				{ class = "AmcoinLedger", min = 5, max = 15, },
...

		{
			...
			group =
			{
				...
				{ category  = "RandomAmmo",             percent = 90 },
				{ category  = "RandomMushroom",         percent = 50  },
				{ category  = "RandomAccessory",        percent = 60  },
				{ class     = "AmcoinLedger",           percent = 5    , min = 1, max = 5},
				{ category  = "RandomEggs",             percent = 20  }, -- Easter event
				{ class     = "GoldenCudgel2",          percent = 24  }, 
				{ class     = "HalloweenBagBrute",      percent = 20  }, --Halloween event.
				{ class     = "ChristmasPresentRare",   percent = 15  }, -- Christmas event
				{ category  = "RandomSpartaGear",       percent = 1  }, 
				{ category  = "RandomBackpackContents", percent = 50 }, 
				{ category  = "RandomPoliceItems"     , percent = 30   },
				{ category = "RandomMedical"     , percent = 30  },
			},
		},
...

		{
			...
			group =
			{
				...
				{ class = "ChristmasPresentRare"   , percent = 45  }, --Christmas event
				{ category  = "RandomSpartaGear"   ,   percent = 1 }, 
...

		{
			...
			group =
			{
				...
				{ class = "WolfPelt" 						   },
                { category = "RandomEggs", percent = 70   },
			},
		},
...

		{
			...
			classes =
			{
				...
				{ category             = "RandomConsumable"      , percent = 5   , min = 1, max = 3 },
		...
		-- Civilian Hunting Items Spawner
		{
			...
			classes =
			{
				{ category  = "RandomHuntingWeapons"    , percent = 23  },
		...
		-- Used in presents and easter eggs
		{
			...
			classes =
			{
				{ class = "christmas_light_string"        , percent = 1 },
				{ class = "christmas_candle"              , percent = 1 },
				{ class = "christmas_gift_pile"           , percent = 1 },
				{ class = "christmas_rug_01"              , percent = 1 },
				{ class = "christmas_rug_02"              , percent = 1 },
				{ class = "SweaterChristmasGreen"         , percent = 1 },
				{ class = "SweaterChristmasRed"           , percent = 1 },
				{ class = "ChristmasHat"                  , percent = 1 },
				{ class = "snowman_small"                 , percent = 1 },
		...
		
		{
			...
			classes =
			{
                ...
                { class = "MotorcycleHelmetSkull"   , percent = 3   },
                { class = "GoldenCudgel2"           , percent = 3   }, 
				{ category = "RandomSpartaGear"     , percent = 2   },
		...
		
		{
			...
			classes =
			{
				{ class = "SpaceHelmet"              , percent = 16.6 },
				{ class = "ScavengerHelmet"          , percent = 16.6 },
                { class = "SpartanHelmet"            , percent = 16.6 },
                { class = "IronsuitPinkHelmet"       , percent = 16.6 },
                { class = "IronsuitWarMachineHelmet" , percent = 16.6 },
                { category = "RandomCivilianHelmet"  , percent = 16.6 },
			},
		},
...

		{
			...
			classes =
			{
				...
				{ class = "guide_concrete", percent = 7 },
			},
		},
		...
		-- Clothes
		{
			...
			classes =
			{
				...
				{ category = "RandomEyes"         , percent = 8  },
				{ category = "RandomFace"         , percent = 8  },
				...
				{ category = "RandomWaist"        , percent = 6  },
				{ category = "RandomMXCloth"      , percent = 6  },
				{ category = "RandomTron"         , percent = 2  },
				{ category = "RandomIronSuite"    , percent = 1  },
			},
		},
		...
		-- Crafting
		{
			...
			classes =
			{
				...
				{ category = "RandomChristmasPresent", percent = 1 	}, -- Christmas event
				{ category = "halloweenBagCommon"    , percent = 1 	}, -- Halloween event
				{ category = "RandomEggs"            , percent = 1 	}, -- Easter event
		...
		-- Gnomes
		{
			...
			classes =
			{
				...
				{ class = "gnome_standard_a", percent = 2 },
				{ class = "gnome_standard_b", percent = 2 },
				{ class = "gnome_standard_c", percent = 2 },
				{ class = "jerry", percent = 6 },
				{ class = "painting_landscape_01", percent = 2 },
				{ class = "painting_landscape_02", percent = 2 },
				{ class = "painting_landscape_03", percent = 2 },
				{ class = "painting_landscape_04", percent = 2 },
				{ class = "painting_landscape_05", percent = 2 },
				{ class = "painting_landscape_06", percent = 2 },
				{ class = "painting_landscape_07", percent = 2 },
				{ class = "painting_landscape_08", percent = 2 },
				{ class = "painting_landscape_09", percent = 2 },
				{ class = "painting_landscape_10", percent = 2 },
				{ class = "painting_square_01", percent = 2 },
				{ class = "painting_square_02", percent = 2 },
				...
				{ class = "painting_map", percent = 2 },
				{ category = "RandomEggs", percent = 2 }, -- Easter event 
				{ class = "CupidArrowx8", percent = 2 }, -- Valentines event
				{ class = "flower_vase", percent = 2 }, -- Valentines event
				{ class = "heart_candle", percent = 2 }, -- Valentines event
		...
		
		{
			...
			classes =
			{
				{ class = "camping_chair"                     , percent = 4 },
				{ class = "propane_heater"                    , percent = 4 },
				{ category = "RandomLantern"                  , percent = 59},
				{ class = "HeatPack"                          , percent = 6 },
				{ class = "camping_pop_up_canopy"             , percent = 5 },
		...
		
		{
			...
			classes =
			{
				{ class = "FlakVestGreen"        , percent = 16   },
				{ class = "FlakVestGreenCamo1"   , percent = 18   },
				{ class = "FlakVestTan"          , percent = 18   },
				{ class = "FlakVestTanCamo1"     , percent = 18   },
		...
		
		{
			...
			classes =
			{
				{ class = "PoliceVestBlack", percent = 30 },
				{ class = "PoliceVestBlue", percent = 30 },
				{ class = "SwatHelmet", percent = 30 },
				{ category = "RandomTron", percent = 10 },
			},
		},
...

		{
			...
			classes =
			{
				...
				{ class = "OpticScopeBow"          , percent = 2.5  },
				...
				{ class = "ReddotSight"            , percent = 6    },
				{ class = "FlashlightMounted"      , percent = 5    },
				{ class = "OPKSight"               , percent = 4    },
				{ class = "R3Sight"                , percent = 5    },
				{ class = "PSOScope"               , percent = 4    },
				{ class = "ext_762x30"             , percent = 3.5  },
				{ class = "ext_556x75"             , percent = 1.5  },
				{ class = "ext_762x75"             , percent = 1.5  },
				{ class = "STANAGx50"              , percent = 1.5  },
				{ class = "HuntingScope"		   , percent = 4    },
                { class = "HuntingScopeRealCamo"       , percent = 2  },
                { class = "HuntingScopeRealCamoDesert" , percent = 2  },
				{ class = "OpticScope"		   	   , percent = 4    },
				{ class = "akval_drummag_75rnd"	   , percent = 1.5  },
				{ class = "762x5"	   			   , percent = 1.5  },
				{ category = "RandomEggs"		   , percent = 4    },
				{ category = "RandomToolRepairKit" , percent = 5.5  },
			},
		},
		...
		},
		{
			...
			classes =
			{
                ...
                { category = "RandomPlasma"      , percent = 2    , min = 3, max = 15 },
                { category = "RandomRocket"      , percent = 2    , min = 1, max = 9 },
                { class = "9mmx10_makarov"       , percent = 2    },
                { class = "9mmx15_m9a1"          , percent = 2    },
                { class = "9mmx19_ap85"          , percent = 2    },
                { class = "acp_45x20"            , percent = 2    },
                { class = "acp_45x30"            , percent = 1    },
                { class = "10mmx15"              , percent = 1    },
...

		{
			...
			classes =
			{
				{ class = "AmmoBox_10mm"    , percent = 10  , min = 30, max = 60 },
				{ class = "AmmoBox_22"      , percent = 10  , min = 30, max = 60 },
				{ class = "AmmoBox_308"     , percent = 10  , min = 30, max = 60 },
				{ class = "AmmoBox_357"     , percent = 5   , min = 30, max = 60 },
				{ class = "AmmoBox_223"     , percent = 5   , min = 30, max = 60 },
				{ class = "AmmoBox_5_45x39" , percent = 8   , min = 30, max = 60 },
				{ class = "AmmoBox_5_56x45" , percent = 8   , min = 30, max = 60 },
				{ class = "AmmoBox_5_70x28" , percent = 8   , min = 30, max = 60 },
				{ class = "AmmoBox_7_62x39" , percent = 8   , min = 30, max = 60 },
				{ class = "AmmoBox_7_62x51" , percent = 8   , min = 30, max = 60 },
				{ class = "AmmoBox_9mm"     , percent = 10  , min = 30, max = 60 },
				{ class = "AmmoBox_acp_45"  , percent = 10  , min = 30, max = 60 },
			},
		},
...

		{
			...
			classes =
			{
                ...
                { class = "guide_concrete"      			, percent = 6 },
                { class = "guide_ammunition"    			, percent = 5 },
...

		{
			...
			classes =
			{
				{ category = "RandomToolRepairKit"       , percent = 13  },
				{ class = "Nails"                        , percent = 25  },
			    { class = "DuctTape"                     , percent = 7   },
			    { class = "Hammer"                       , percent = 9   },
			    { class = "LugWrench"                    , percent = 8   },
			    { class = "SparkPlugs"                   , percent = 9   },
			    { class = "DriveBelt"                    , percent = 9   },
				{ class = "Sledgehammer"                 , percent = 1.5 },
				{ class = "RK_Sledgehammer"              , percent = 1   },
				{ class = "Icepickaxe"                   , percent = 10  },
                { class = "guide_concrete"   			 , percent = 5.5 },
                { category = "RandomSilencer"			 , percent = 2   , min = 1, max = 1 },
			},
		},
...

		{
			...
			classes =
			{
				...
				{ class = "EmptyBottle"           , percent = 9  },
				{ class = "Rags"                  , percent = 5  },
				{ class = "BalaclavaBlack"        , percent = 5  },
				{ class = "Rope"                  , percent = 10 },
				{ class = "DuctTape"              , percent = 15 },
...

		{
			...
			classes =
			{
				{ category             = "RandomMaintenance"        , percent = 6  },
				{ class                = "Amalgaduino"              , percent = 10 },
				{ category             = "RandomSeeds"              , percent = 1  },
...

		{
			...
			classes =
			{
				{ category = "RandomChristmasPresent"  , percent = 0.5  }, -- Christmas event
				{ category = "halloweenBagCommon"      , percent = 0.5  }, -- Halloween event
				{ category = "RandomEggs"              , percent = 0.5  }, -- Easter event
				{ category = "RandomRangedPolicePure"  , percent = 7    },
				{ category = "RandomMilitaryClothing"  , percent = 7    },
...

		{
			...
			classes =
			{
				...
				{ category  = "RandomSpartaGear"                , percent = 2   }, -- Easter event
		...
		-- Custom Metal Parts
		{
			...
			classes =
			{
				{ class = "brick_angled_roof_3x4x4"                  , percent = 1      },
				{ class = "concrete_wall_3m_2m_white"                , percent = 1      },
				{ class = "concrete_wall_3m_2m_white"                , percent = 1      },
				{ class = "marble_wall_3m_4m"                        , percent = 1      }, 
				{ class = "brick_wall_3m_2m_window"                  , percent = 2      },
				{ class = "concrete_wall_window_3m_4m_white"         , percent = 2      },
				{ class = "plastered_wall_3m_2m_window"              , percent = 2      },
				{ class = "rock_wall_3m_4m"                          , percent = 1      },
				{ class = "plastered_wall_black_3m_2m_window"        , percent = 3      }, 
				{ class = "plastered_wall_green_3m_4m_door"          , percent = 2      },
				{ class = "plastered_wall_red_3m_4m"                 , percent = 2      },
				{ class = "plastered_angled_roof_3x4x4"              , percent = 2      },
				{ class = "classic_platform_3m_4m_4m"                , percent = 2      },
				{ class = "brick_column_3m"                          , percent = 2      },
				{ class = "brick_wall_3m_2m"                         , percent = 1      },
				{ class = "cobblestone_column_3m"                    , percent = 1      },
				{ class = "cobblestone_platform_3m_4m_4m"            , percent = 2      },
				{ class = "brick_wall_3m_4m_door"                    , percent = 4      },
				{ class = "rock_doorway_3m_4m"                       , percent = 4      },
				{ class = "glass_wall_1_3m_4m"                       , percent = 3      },
				{ class = "glass_door_3m_2m"                         , percent = 3      },
				{ class = "window"                                   , percent = 3      },
				{ class = "glass_wall_2m_4m"                         , percent = 3      },
				{ class = "glass_wall_3m_4m"                         , percent = 4.5          },
				{ class = "glass_wall_3m_4m"				         , percent = 1      },
				{ class = "glass_wall_3m_8m"				         , percent = 1      },
				{ class = "concrete_gate_z"				             , percent = 1      },
				{ class = "concrete_platform_16m_16m_black"	         , percent = 1        },
				{ class = "brick_wall_3m_4m"                         , percent = 1      , min = 2, max = 5 },
				{ class = "titanium_wall_3m_4m"                      , percent = 2      , min = 2, max = 5 },
				{ class = "titanium_platform_3m_4m_4m_stairs"        , percent = 2      , min = 1, max = 2 },
				{ class = "titanium_crenelation"                     , percent = 2      , min = 1, max = 2 },
				{ class = "titanium_wall_3m_4m_door"                 , percent = 2      , min = 1, max = 2 },		
                { class = "concrete_wall_door_3m_4m_black"           , percent = 2      , min = 1, max = 2 },	
                { class = "RangerTower_Packed"   		             , percent = 1      },
                { class = "Left_Clean_Fence_Mesh_nz"   		         , percent = 2      },
                { class = "Right_Clean_fence_Mesh_nz"   	         , percent = 1      },
                { class = "postonly_nz"   		                     , percent = 1      },
                { class = "light_tower_tall"   		                 , percent = 2      },
                { class = "6mx6m_corrugated_metal_02"                , percent = 2      },
                { class = "marble_wall_green_3m_4m"                  , percent = 1      , min = 1, max = 2 },
                { class = "marble_platform_green_3m_8m_8m"           , percent = 1.5        , min = 1, max = 2 },
                { class = "marble_column_3m_black"                   , percent = 1      , min = 1, max = 2 },
                { class = "marble_ceiling_4m_4m_blue"                , percent = 1      , min = 1, max = 2 },
                { class = "marble_ceiling_8m_8m_black"               , percent = 1      , min = 1, max = 2 },
                { class = "base_24store_door"                        , percent = 1      , min = 1, max = 2 },
                { class = "base_modern_family_door"                  , percent = 1      , min = 1, max = 2 },
                { class = "garage_gate_6m_4m"                        , percent = 1       },
                { class = "Gateframe_6m_4m"                          , percent = 1       },
                { class = "Gateframe_6m_8m"                          , percent = 1       },
                { class = "garage_gate_6m_8m"                        , percent = 1       },
                { class = "marble_foundation_black_4m_4m_4m"         , percent = 2      , min = 1, max = 2 },
                { class = "marble_wall_3m_2m_window"                 , percent = 1      , min = 1, max = 2 },
                { class = "marble_wall_black_3m_4m"                  , percent = 0.5      , min = 1, max = 2 },
                { class = "marble_platform_3m_4m_4m_stairs"          , percent = 0.5      , min = 1, max = 2 },
                { class = "rock_wall_window_3m_2m_beamless"          , percent = 0.5      , min = 1, max = 2 },
                { class = "rock_wall_4m_4m"                          , percent = 1      , min = 1, max = 2 },
                { class = "cobblestone_wall_3m_2m"                   , percent = 1      , min = 1, max = 2 },
				{ category = "RandomPrefab"	    		             , percent = 0.5       },
                { class = "Concrete_wall_3x8_gold"                   , percent = 0.5      , min = 1, max = 2 },        
				{ class = "round_platform_conctete_0x8_gold"         , percent = 0.5      , min = 1, max = 2 },
                { class = "Concrete_triangle_roof_3x4x4_02_black"    , percent = 0.5      , min = 1, max = 2 },
                { class = "Glass_Platform_HMS_3x4x4"                 , percent = 1      , min = 1, max = 2 },
                { class = "Glass_Platform_HMS_3x8x8"                 , percent = 0.5      , min = 1, max = 2 },
                { class = "Glass_Platform_HMS_3x16x16"               , percent = 0.5      , min = 1, max = 2 },
                { class = "Concrete_curve_wall_window_3x4x4_02_white", percent = 0.5      , min = 1, max = 2 },
                { class = "Concrete_curve_wall_stairs_3x4x4_gold"    , percent = 0.5      , min = 1, max = 2 },    
                { class = "Concrete_curve_wall_3x4x4_grey"           , percent = 0.5      , min = 1, max = 2 },    
			},
		},
		
		{
			...
			classes =
			{
				{ class = "one_story_white"              , percent =  5.5  },
				{ class = "one_story_green"              , percent =  10   },
				{ class = "one_story_red"                , percent =  6.5  },
				{ class = "one_story_black"              , percent =  8    },
				{ class = "cabin_wood_black"             , percent =  7    },
                { class = "cabin_wood_simple"    		 , percent =  7    },
                { class = "cabin_wood_simple_black"      , percent =  10   },
				{ class = "cabin_wood_simple_red"        , percent =  10   },
				{ class = "cabin_wood"                   , percent =  7    },
				{ class = "villa_red"					 , percent =  10   },
				{ class = "villa_black"					 , percent =  7    },
				{ class = "villa_white"					 , percent =  10   },
				{ class = "carliftbase"					 , percent =  1    },
				{ class = "carlift"						 , percent =  1    },
			},
		},
...

		{
			...
			group =
			{
				...
				{ class = "Peacemaker"                       , percent = 50                    },
				{ class = "SpaceHelmet"                      , percent = 50                    },
                { class = "MotorcycleHelmetSkull"			 , percent = 50                    },
				{ class = "titanium_wall_3m_4m"     		 , percent = 50  , min = 2, max = 5},
				{ class = "titanium_platform_3m_4m_4m_stairs", percent = 20                    },
				{ class = "titanium_wall_3m_4m"     		 , percent = 10  , min = 5, max = 8},
		...
		
		{
			...
			group =
			{
                ...
                { class = "SAPOCBriefcaseClosed"       , percent = 45  },
		...
		
		{
			...
			group =
			{
                ...
                { category = "RandomSkullGear"    			  , percent = 30 	},
		...
		
		{
			...
			group =
			{
				...
				{ class = "Lumber"                         , percent = 100, min = 64, max = 128 },
                { class = "IronIngot"                      , percent = 100, min = 64, max = 128 },
                { class = "IronIngot"                      , percent = 100, min = 64, max = 128 },
				{ class = "IronOre"                        , percent = 100, min = 64, max = 128 },
                { class = "IronOre"                        , percent = 100, min = 64, max = 128 },
				...
				{ class = "ScrapMetal"                     , percent = 100, min = 10, max = 60  },
                { class = "ScrapMetal"         			   , percent = 100, min = 10, max = 60  },
				{ class = "ScrapMetal"         			   , percent = 100, min = 10, max = 60  },
				...
				{ category = "RandomMetalParts"            , percent = 100 },
                { category = "RandomMetalParts"            , percent = 100 },
				{ class = "ConcreteBag"                    , percent = 100  , min = 3, max = 15 },
                { class = "ConcreteBag"       			   , percent = 100  , min = 3, max = 15 },
				{ category = "RandomPaintCan"              , percent = 100 },
                { category = "RandomGlassParts"            , percent = 100 },

				{ class = "WorkLight"                      , percent = 50   ,min = 1, max = 5 },                
				{ class = "CamoNetting"                    , percent = 30   , min = 5, max = 10 },
				{ class = "guide_concrete"                 , percent = 82  },
                { category = "RandomMetalParts"            , percent = 75  },
				{ category = "RandomMetalParts"            , percent = 75  },
				{ category = "RandomMetalParts"            , percent = 75  },
				{ category = "RandomMetalParts"            , percent = 75  },
				{ class = "Icepickaxe"                     , percent = 50  },
				{ class = "Icepickaxe"                     , percent = 25  },
                { class = "Pickaxe"                        , percent = 25  },
                { class = "Hammer"                         , percent = 25  },
                { class = "Hammer"                         , percent = 25  },
				{ category = "RandomTent"                  , percent = 80  },
				{ class = "ElectricalParts"                , percent = 50   , min = 5, max = 50},
                { class = "DuctTape"                       , percent = 50   , min = 5, max = 50},
		...
		
		{
			...
			group =
			{
				...
				{ category = "VendorSniper"            , percent = 100 },
				{ class = "GrenadePickup"              , percent = 100 },
                { class = "SwatHelmet"                 , percent = 100 },
				{ category = "RandomDuffelBag"         , percent = 100 },

                { class = "AT15"                       , percent = 40 },
				{ class = "STANAGx50"                  , percent = 80 },
                { class = "STANAGx50"      			   , percent = 80 },
				{ category = "RandomAllHazmatSuit"     , percent = 50 },
				...
				{ class = "ext_762x75"                 , percent = 16 },
				{ class = "ext_556x75"                 , percent = 17 },
				{ class = "akval_drummag_75rnd"        , percent = 30 },
                { class = "SCAAMAmalgarmin"			   , percent = 5}, 
				{ class = "PlasmaRifle"		   		   , percent = 20  },
				{ category = "RandomPlasma"			   , percent = 90 },
				{ class = "SCAR-H"			           , percent = 50  },
		...
		
		{
			...
			group =
			{
                ...
                { category = "RandomAmmoBox"                 , percent = 100 },
                { class = "GoldenCudgel2"                    , percent = 100 },
                { class = "Binoculars"                       , percent = 100  },
                { class = "SCAAMShovel"                      , percent = 100  },
                { class = "SCAAMAmalgarmin"                  , percent = 100  },
                { category = "RandomCivilianHelmet"          , percent = 100   },
                { class = "SAPOCBriefcaseClosed"             , percent = 20  },
                { class = "SAPOCBriefcaseClosed"             , percent = 20  },
		...
		
		{
			...
			group =
			{
                { class = "GrenadeMolotovPickup" , percent = 100  , min = 1, max = 5  },
                { class = "GrenadeMolotovPickup" , percent = 100  , min = 1, max = 5  },
                { class = "EmptyBottle"          , percent = 100  , min = 1, max = 5  },
                { class = "GrenadePickup"        , percent = 100  , min = 1, max = 5  },
                { class = "GrenadePickup"        , percent = 100  , min = 1, max = 5  },
                { class = "GrenadePickup"        , percent = 100  , min = 1, max = 5  },
                { class = "Amalgaduino"          , percent = 100  , min = 1, max = 15 },
                { class = "Pile_40mmGrenade"     , percent = 100  , min = 1, max = 5  },
                { class = "Icepickaxe"           , percent = 100  },
                { class = "guide_explosives_1"   , percent = 100  },
				{ class = "guide_explosives_2"   , percent = 100  },
                { class = "PipebombPickup"       , percent = 100  , min = 1, max = 5  },
                { class = "PipebombPickup"       , percent = 100  , min = 1, max = 5  },
                { class = "C4TimedPickup"        , percent = 100  , min = 1, max = 1  },
                ...
                { category = "RandomPlasma"      , percent = 100  , min = 3, max = 10 },
				...
				{ class = "GrenadeMolotovPickup" , percent = 50  , min = 1, max = 5  },
				{ class = "GrenadeMolotovPickup" , percent = 50  , min = 1, max = 5  },
				{ class = "GrenadeMolotovPickup" , percent = 50  , min = 1, max = 5  },
				{ class = "Amalgaduino"          , percent = 50  , min = 1, max = 10 },
				{ class = "ElectricalParts"      , percent = 50  , min = 1, max = 10 },
				{ class = "C4TimedPickup"        , percent = 1   , min = 1, max = 3  },
				{ class = "C4TimedPickup"        , percent = 25  , min = 1, max = 3  },
				{ class = "M97"                  , percent = 15  },
				{ class = "PlasmaRifle"          , percent = 35  },
				{ class = "RocketLauncherNew"    , percent = 15  },
                { class = "SAPOCBriefcaseClosed" , percent = 35  },
                { class = "SAPOCBriefcaseClosed" , percent = 10  },
		...
		
        {
			...
			classes =
			{
				{ category = "glass_doorway_3m_2m"       , percent = 0.32 },
				{ category = "glass_doorway_3m_4m"       , percent = 0.32 },
				{ category = "glass_doorway_3m_4m_side"  , percent = 0.32 },
                { category = "glass_doorway_3m_4m_v2"    , percent = 0.32 },
                { category = "glass_doorway_3m_8m"       , percent = 0.32 },
                { category = "glass_wall_1_3m_2m"        , percent = 0.32 },
                { category = "glass_wall_1_3m_4m"        , percent = 0.32 },
                { category = "glass_wall_1_3m_8m"        , percent = 0.32 },
                { category = "glass_wall_1_3m_12m"       , percent = 0.32 },
                { category = "glass_wall_1_3m_16m"       , percent = 0.32 },
                { category = "glass_wall_2m_2m"          , percent = 0.32 },
                { category = "glass_wall_2m_4m"          , percent = 0.32 },
                { category = "glass_wall_2m_8m"          , percent = 0.32 },
                { category = "glass_wall_2m_12m"         , percent = 0.32 },
                { category = "glass_wall_2m_16m"         , percent = 0.32 },
                { category = "glass_wall_3m_2m"          , percent = 0.32 },
                { category = "glass_wall_3m_4m"          , percent = 0.32 },
                { category = "glass_wall_3m_8m"          , percent = 0.32 },
                { category = "glass_wall_3m_12m"         , percent = 0.32 },
                { category = "glass_wall_3m_16m"         , percent = 0.32 },
                { category = "glass_door_2m_1m"          , percent = 0.32 },
                { category = "glass_door_3m_2m"          , percent = 0.32 },
                { category = "window"                    , percent = 0.32 },
                { category = "door_glass_white"          , percent = 0.32 },
                { category = "Glass_Platform_HMS_3x16x16", percent = 0.32 },
                { category = "Glass_Platform_HMS_3x12x12", percent = 0.32 },
                { category = "Glass_Platform_HMS_3x8x8"  , percent = 0.32 },
                { category = "Glass_Platform_HMS_3x4x4"  , percent = 0.32 },
                { category = "Glass_Platform_HMS_0x16x16", percent = 0.32 },
                { category = "Glass_Platform_HMS_0x12x12", percent = 0.32 },
                { category = "Glass_Platform_HMS_0x8x8"  , percent = 0.32 },
                { category = "Glass_Platform_HMS_0x4x4"  , percent = 0.32 },
			},
		},
		...
		
		{
            ...
            group =
            {
				...
				{ category = "RandomMilitaryArmor"             , percent = 100  },
                { category = "RandomAmmoBox"                   , percent = 100  },
				{ class 	= "AmcoinLedger"                   , percent = 100   , min = 10, max = 50 },
				...
				{ category = "RandomSpartaGear"           	   , percent = 20 	},
                { category = "RandomAmmoBox"  				   , percent = 9 	},
                { category = "RandomAmmoBox"  				   , percent = 9 	},
                { category = "RandomAmmoBox"  				   , percent = 9 	},
                ...
                { category = "RandomTron"     				   , percent = 15 	},
				{ category  = "RandomPlasma"			   		   , percent = 50 	 , min = 3, max = 40 },
				{ category  = "RandomPlasma"			   		   , percent = 50 	 , min = 3, max = 40 },
				{ class = "PlasmaRifle"			   		       , percent = 10 	},
				{ class = "PlasmaRifle"			   		       , percent = 5 	},
				{ class = "RocketLauncherNew"			       , percent = 15 	},
				{ category = "RandomRocket"			   		   , percent = 100 	 , min = 10, max = 40 },
				{ category = "RandomRocket"		   	   		   , percent = 100	 , min = 3, max = 5 },
                { class = "SAPOCBriefcaseClosed"               , percent = 30   },
                { class = "SAPOCBriefcaseClosed"               , percent = 30   },
                { category = "EventHelmets"                    , percent = 5   },
                { class = "AssaultHelmet"       			   , percent = 5 	},
                { category = "RandomSkullGear"    			   , percent = 100 	},
                { class = "SalazarSkull"             , percent = 100    },
                { class = "wood_coffin"              , percent = 6.5  },
                { category = "RandomEpicAttachmentTrader", percent = 7   },
                { category = "HalloweenBagRare", percent = 80   },
                { category = "RandomEpicWeaponPure"    , percent = 100 },
                { category = "RandomSkullGear"    , percent = 80 },
                { category = "RandomRangedPolicePure"  , percent = 100 },
                { category = "RandomRangedCivilianPure"      , percent = 100 },
                { class = "Pile_40mmGrenade"     , percent = 100  , min = 1, max = 5  },
                { category = "RandomSilencer"	 , percent = 100   , min = 1, max = 1 },
                { class = "daftpunkhelmet2"                  , percent =50 },
                { class = "daftpunkhelmet"                   , percent = 50 },
                { class = "ethahelmetgreen"                  , percent = 25 },
                { class = "ethahelmet"                       , percent = 25 },
            },
        },
...

		{
			...
			group =
			{
				...
				{ class = "RK_Icepickaxe", percent = 100 },
...

		{
			...
			classes =
			{
                ...
                { class = "guide_concrete"       			 , percent = 4 },
...

        {
			...
			classes =
			{
				{ class = "RifleSilencer", percent = 30 },
