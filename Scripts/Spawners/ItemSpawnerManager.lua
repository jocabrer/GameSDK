	...
	itemCategories =
	{
		...
		
		{
			...
			classes =
			{
				...
				--{ class = "ArmoredGhillieSuit"   , percent = 9    },
		...
		
		{
			...
			group =
			{
				...
				{ class = "akval_drummag_75rnd"        , percent = 80  },
				{ class = "akval_drummag_75rnd"        , percent = 80  },
				{ class = "ReddotSight"                , percent = 100 },
				{ class = "VSS"                        , percent = 10  },
				{ class = "M4V5"                       , percent = 2   },
				{ class = "RPK"                        , percent = 2   },
				--{ class = "EggBlue"                    , percent = 100  , min = 1, max = 20 }, -- Easter event
				--{ class = "EggGreen"                   , percent = 100  , min = 1, max = 20 }, -- Easter event
				--{ class = "EggPink"                    , percent = 100  , min = 1, max = 20 }, -- Easter event
                { category = "RandomTron"  			   , percent = 10  },
				...
				{ category = "RandomRocket"			   , percent = 2    , min = 10, max = 40 },
		...
		
		{
			...
			group =
			{
				...
				{ category = "RandomPaintCan"              , percent = 50   },
		...
		
		{
			...
			group =
			{
                ...
                { category = "RandomRocket"      , percent = 100  , min = 1, max = 10},
                { category = "RandomRocket"      , percent = 100  , min = 1, max = 10},
                { category = "RandomPlasma"      , percent = 100  , min = 2, max = 40 },
                { category = "RandomPlasma"      , percent = 100  , min = 2, max = 10 },
                ...
                { category = "RandomPlasma"      , percent = 45   , min = 2, max = 40 },
                { category = "RandomRocket"      , percent = 50   , min = 1, max = 10},
                
				
				{ class = "GrenadeMolotovPickup" , percent = 50 },
				{ class = "GrenadeMolotovPickup" , percent = 50 },
				{ class = "GrenadeMolotovPickup" , percent = 50 },
				...
				{ class = "GrenadePickup"        , percent = 80  },
				{ class = "Pile_40mmGrenade"     , percent = 15, min = 1, max = 5 },
				{ class = "Pile_40mmGrenade"     , percent = 35, min = 1, max = 3 },
				{ class = "guide_explosives_1"   , percent = 50 },
				{ class = "guide_explosives_2"   , percent = 50 },
				{ class = "PipebombPickup"       , percent = 1, min = 1, max = 3 },
				{ class = "PipebombPickup"       , percent = 10, min = 1, max = 3 },
				{ class = "C4TimedPickup"        , percent = 1, min = 1, max = 3 },
				{ class = "C4TimedPickup"        , percent = 25, min = 1, max = 3 },
				{ class = "C4TimedPickup"        , percent = 15, min = 1, max = 1 },
				
				-- { class = "BioFuel"              , percent = 50, min = 40, max = 128 },
				{ class = "M97"                  , percent = 40 },
				{ class = "M97"                  , percent = 15 },
				{ class = "PlasmaRifle"          , percent = 65 },
                { class = "PlasmaRifle"          , percent = 35 },

				{ class = "RocketLauncherNew"    , percent = 45  },
                { class = "SAPOCBriefcaseClosed" , percent = 80  },
                { class = "SAPOCBriefcaseClosed" , percent = 20  },

                { category  = "RandomPlasma"      , percent = 45   , min = 2, max = 40 },
				{ category  = "RandomPlasma"      , percent = 15   , min = 2, max = 40 },
				{ category  = "RandomPlasma"      , percent = 80   , min = 2, max = 40 },
