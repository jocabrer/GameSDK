...

       {
        ...
        
		{
			...
			classes =
			{
				...
				{ class = "one_story_red"                   , percent =  3   },
				{ class = "one_story_black"                 , percent =  5   },
				{ class = "cabin_wood_black"                , percent =  3   },
                { class = "cabin_wood_simple"    		    , percent =  3   },
                { class = "cabin_wood_simple_black"         , percent =  3   },
				...
				{ class = "carliftbase"					    , percent =  4   },
				{ class = "carlift"						    , percent =  4   },
                { class = "barracks_middle_brick_concrete"  , percent =  4   },
                ...
                { class = "FlowerPotA_HMS"                  , percent =  3   },
                { class = "FlowerPotB_HMS"                  , percent =  3   },
                { class = "FlowerPotC_HMS"                  , percent =  3   },
                { class = "FlowerPotD_HMS"                  , percent =  3   },
                { class = "FlowerPotE_HMS"                  , percent =  3   },
			},
		},
