...
--]]
	...
	itemCategories =
	{
...

		{
			...
			group =
			{
				{ category  = "RandomAmmo",             percent = 60   , min = 1, max = 6 },
                { category  = "RandomAmmo",             percent = 40   , min = 1, max = 6 },
                { category  = "RandomAmmo",             percent = 50   , min = 1, max = 6 },
				{ category  = "RandomMushroom",         percent = 50   , min = 1, max = 6 },
				{ class     = "AmcoinLedger",           percent = 30   , min = 5, max = 10},
		...
		},
		{
			...
			classes =
			{
                ...
                { class = "Pile_Flare"           , percent = 5.88    , min = 1, max = 25 },
