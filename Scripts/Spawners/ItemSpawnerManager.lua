	...
	itemCategories =
	{
...

		{
			...
			classes =
			{
				...
				{ class = "DuffelBagGreenCamo4", contents="RandomBackpackAirPlaneContents", percent = 10 },
				{ class = "DuffelBagTanCamo1"  , contents="RandomBackpackAirPlaneContents", percent = 5  },
				{ class = "DuffelBagTanCamo2"  , contents="RandomBackpackAirPlaneContents", percent = 10 },
				{ class = "DuffelBagTanCamo3"  , contents="RandomBackpackAirPlaneContents", percent = 5  },
				{ class = "DuffelBagTanCamo4"  , contents="RandomBackpackAirPlaneContents", percent = 10 },
				...
				{ class = "DuffelBagUrbanCamo3", contents="RandomBackpackAirPlaneContents", percent = 10 },
