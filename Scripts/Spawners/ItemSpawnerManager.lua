	...
	itemCategories =
	{
		...
		
		{
			...
			group =
			{
                ...
                { class = "Nails"                          , percent = 100, min = 12, max = 36 },
				...
				{ class = "ConcreteBag"                    , percent = 100  , min = 3, max = 10 },
				...
				{ class = "WorkLight"                      , percent = 50   ,min = 1, max = 2 },              
                ...
                { class = "AmcoinLedger"                   , percent = 20  , min = 1, max = 128 },
                { class = "AmcoinLedger"                   , percent = 50  , min = 1, max = 128 },
			},
		},
