	...
	itemCategories =
	{
		...
		-- Used in presents and easter eggs
		{
			...
			classes =
			{
				...
				{ class = "christmas_candle"              , percent = 4 },
				{ class = "christmas_gift_pile"           , percent = 4 },
				{ class = "christmas_rug_01"              , percent = 4 },
		...
		-- Custom Metal Parts
		{
			...
			classes =
			{
                ...
                { category = "RandomLetra"                           , percent = 6      },
                { category = "RandomPlastered"                       , percent = 6      },
                { category = "RandomConcrete"                        , percent = 5      },
                { category = "RandomPrefab"	    		             , percent = 1      },
                { category = "RandomGlassParts"   		             , percent = 5      },
                { category = "RandomTitanium"   		             , percent = 6      },
                { category = "RandomMarmol"       		             , percent = 6      },
                { category = "RandomTent"       		             , percent = 5      },
                { class = "brick_angled_roof_3x4x4"                  , percent = 1.7    },
				{ class = "marble_wall_3m_4m"                        , percent = 1.7    }, 
				{ class = "brick_wall_3m_2m_window"                  , percent = 1.7    },
				{ class = "rock_wall_3m_4m"                          , percent = 1.7    },
				{ class = "classic_platform_3m_4m_4m"                , percent = 1.7    },
				{ class = "brick_column_3m"                          , percent = 1.7    },
				{ class = "brick_wall_3m_2m"                         , percent = 1.7    },
				{ class = "cobblestone_column_3m"                    , percent = 1.7    },
				{ class = "cobblestone_platform_3m_4m_4m"            , percent = 1.7    },
				{ class = "brick_wall_3m_4m_door"                    , percent = 1.7    },
				{ class = "rock_doorway_3m_4m"                       , percent = 1.7    },
				{ class = "brick_wall_3m_4m"                         , percent = 1.7    , min = 2, max = 5 },
                { class = "Left_Clean_Fence_Mesh_nz"   		         , percent = 1.7    },
                { class = "Right_Clean_fence_Mesh_nz"   	         , percent = 1.7    },
                { class = "marble_wall_green_3m_4m"                  , percent = 1.7    , min = 1, max = 2 },
                { class = "marble_platform_green_3m_8m_8m"           , percent = 1.7    , min = 1, max = 2 },
                { class = "marble_column_3m_black"                   , percent = 1.7    , min = 1, max = 2 },
                { class = "marble_ceiling_4m_4m_blue"                , percent = 1.7    , min = 1, max = 2 },
                { class = "marble_ceiling_8m_8m_black"               , percent = 1.7    , min = 1, max = 2 },
                { class = "base_24store_door"                        , percent = 1.7    , min = 1, max = 2 },
                { class = "base_modern_family_door"                  , percent = 1.7    , min = 1, max = 2 },
                { class = "garage_gate_6m_4m"                        , percent = 1.7    },
                { class = "Gateframe_6m_4m"                          , percent = 1.7    },
                { class = "Gateframe_6m_8m"                          , percent = 1.7    },
                { class = "marble_foundation_black_4m_4m_4m"         , percent = 1.7    , min = 1, max = 2 },
                { class = "marble_wall_3m_2m_window"                 , percent = 1.7    , min = 1, max = 2 },
                { class = "marble_wall_black_3m_4m"                  , percent = 1.7    , min = 1, max = 2 },
                { class = "marble_platform_3m_4m_4m_stairs"          , percent = 1.7    , min = 1, max = 2 },
                { class = "rock_wall_window_3m_2m_beamless"          , percent = 1.7    , min = 1, max = 2 },
                { class = "rock_wall_4m_4m"                          , percent = 1.7    , min = 1, max = 2 },
                { class = "cobblestone_wall_3m_2m"                   , percent = 1.7    , min = 1, max = 2 },
			},
		},
        {
