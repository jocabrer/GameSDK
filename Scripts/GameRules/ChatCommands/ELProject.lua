...
ELPAmmoTable = {
    ...
    ['AT15'] = {'STANAGx30', 'ext_556x75', 'Pile_556x45'},
    ['AUMP45'] = {'acp_45x30', 'Pile_45ACP'},
    ['Bulldog'] = {'STANAGx30', 'ext_556x75', 'Pile_556x45'},
    ['ColtPython'] = {'Pile_357'},
    ...
    ['M4A1'] = {'STANAGx30', 'ext_556x75', 'Pile_556x45'},
    ['M4V5'] = {'STANAGx30', 'ext_556x75', 'Pile_556x45'},
    ['M9A1'] = {'9mmx15_m9a1', 'Pile_9mm'},
    ['M16'] = {'STANAGx30', 'ext_556x75', 'Pile_556x45'},
    ['M16Vietnam'] = {'STANAGx30', 'ext_556x75', 'Pile_556x45'},
    ...
    ['Mk18Reaver'] = {'STANAGx30', 'ext_556x75', 'Pile_556x45'},
    ['Model70'] = {'Pile_223'},
    ['Model1873'] = {'Pile_357'},
