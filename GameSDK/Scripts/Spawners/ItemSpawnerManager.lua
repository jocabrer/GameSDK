...
local SEASONAL     = ((MONTH == 11 or MONTH == 12) and 1.15 or 1.0) -- leve boost navideño
local LOOT         = { GLOBAL = 1.0, CONTAINER = 1.0, AI = 1.0, EVENT = 1.0, SEASONAL = SEASONAL }
local TIER         = { COMMON = 1.0, UNCOMMON = 0.7, RARE = 0.4, EPIC = 0.2, LEGENDARY = 0.05 }
...
--]]
	...
	itemCategories =
	{
		...
		-- A random epic spawn for hard to reach areas. Use sparingly.
		{
			...
			classes =
			{
				-- rifles épicos (moderado 8%)
				{ category = "Mk18ReaverWithMagazines",        percent = 8 },
				{ category = "AKMGoldWithMagazines",           percent = 8 },
				{ category = "M4A1WithMagazines",              percent = 8 },
				{ category = "M16VietnamWithMagazines",        percent = 8 },
				{ category = "VSSWithMagazines",               percent = 8 },
				{ category = "RPKWithMagazines",               percent = 8 },
				{ category = "M4V5WithMagazines",              percent = 8 },
				{ category = "PeacemakerWithMagazines",        percent = 8 },
				{ category = "SCAR-H",                         percent = 8 },
				{ category = "G36C",                           percent = 8 },

				-- especiales “con rounds” (más raros, 5%)
				{ category = "ColtPythonGrimeyRickWithRounds", percent = 5 },
				{ category = "mutantsilencerWithRounds",       percent = 5 },

				-- cuerpo a cuerpo “skins” (3%)
				...
				{ class = "mutantsilencer",                    percent = 3 },

				-- ultra raros (1% o menos)
				{ class = "PlasmaRifle",                       percent = 1 },
				{ class = "RocketLauncherNew",                 percent = 0.5 },
			},
		},
		{
			...
			classes =
			{
				-- Rifles/épicos estándar (7-8%)
				{ class = "Mk18Reaver",            percent = 8 },
				{ class = "M16Vietnam",            percent = 8 },
				{ class = "VSS",                   percent = 8 },
				{ class = "RPK",                   percent = 7 },
				{ class = "M4V5",                  percent = 7 },
				{ class = "AKMGold",               percent = 7 },
				{ class = "M4A1",                  percent = 7 },
				{ class = "SCAR-H",                percent = 7 },

				-- Cuerpo a cuerpo especiales (5%)
				{ class = "AxePatrick",            percent = 5 },
				{ class = "BaseballBatHerMajesty", percent = 5 },
				{ class = "KatanaBlackWidow",      percent = 5 },

				-- Semi-raros / curiosos (2-3%)
				{ class = "ColtPythonGrimeyRick",  percent = 3 },
				{ class = "G36C",                  percent = 3 },
				{ class = "mutantsilencer",        percent = 3 },
...

		{
			...
			classes =
			{
				{ class = "Flashlight",        percent = 5 }, -- la básica, poco común
				{ class = "FlashlightPistol",  percent = 15 },
				{ class = "FlashlightMounted", percent = 15 },
				{ class = "FlashlightRifle",   percent = 15 },
				{ class = "Headlamp",          percent = 20 }, -- más útil, la más común
				{ class = "HeadlampRed",       percent = 10 }, -- variante algo más rara
				{ class = "Maglite",           percent = 10 },
...

		{
			...
			classes =
			{
				...
				{ class = "CraftedPistol",              percent = 5 },
				{ class = "CraftedRifleLong",           percent = 5 },
				{ class = "CraftedSMG",                 percent = 5 },
				{ class = "CraftedLongPistol",          percent = 5 },
				{ class = "CraftedPistol556",           percent = 5 },
				{ class = "CraftedRifle9mm",            percent = 5 },
				{ class = "CraftedShortRifle556",       percent = 5 },
				{ class = "CraftedShortShotgun",        percent = 5 },
				{ class = "CraftedShotgun",             percent = 5 },
			},
		},
...

		{
			...
			classes =
			{
				...
				{ category = "RandomAmmo",         percent = 5,  min = 1, max = 1 },
			},
		},
...

		{
			...
			group =
			{
				{ class = "CarBattery", percent = 55 },
				{ class = "DriveBelt",  percent = 85 },
...

		{
			...
			classes =
			{
				...
				{ class = "SparkPlugs",             percent = 5 },
				{ class = "Wheel",                  percent = 20, min = 1, max = 2 },
				{ class = "Oil",                    percent = 4 },
...

		{
			...
			classes =
			{
				...
				{ class = "Wheel",          percent = 20, min = 1, max = 2 },
				{ class = "Oil",            percent = 15 },
				{ class = "JerryCanDiesel", percent = 25 },
			},
		},

		{
			...
			classes =
			{
				...
				{ class = "CarBattery",            percent = 5 },
				{ class = "DriveBelt",             percent = 5 },
				{ class = "AmcoinLedger",          percent = 1, min = 1, max = 5 },
		...
		-- AI
		{
			...
			group =
			{
				...
				{ category = "RandomAmmo",              percent = 40, min = 1, max = 1 }, -- subido
				{ category = "RandomMedical",           percent = 25 },       -- subido
				{ category = "RandomConsumable",        percent = 10 },       -- bajado
				{ category = "RandomClothes",           percent = 15 },       -- bajado
...

		{
			...
			group =
			{
				...
				{ class = "AmcoinLedger",                percent = 18, min = 1, max = 15 },
				{ category = "RandomSpartaGear",         percent = 1 },
				{ category = "RandomMedical",            percent = 20 },
				{ category = "SmallHidingPlaceContent",  percent = 5 },
				{ category = "MediumHidingPlaceContent", percent = 2 },
				{ category = "RandomConsumable",         percent = 49 },
				{ category = "RandomClothes",            percent = 25 },
				{ category = "RandomFood",               percent = 45 },
...

		{
			...
			group =
			{
				{ class = "AmcoinLedger",              percent = 18, min = 1, max = 10 },
				{ category = "RandomMedical",          percent = 50 }, -- tiene más lógica
				{ category = "RandomAmmo",             percent = 25, min = 1, max = 1 },
				{ category = "RandomCargador",         percent = 30, min = 5, max = 15 },
				{ category = "RandomBackpackContents", percent = 25 },
				{ class = "SAPOCBriefcaseClosed",      percent = 1,  min = 1, max = 1 }, -- drop mágico ultra raro
				{ category = "RandomConsumable",       percent = 5 },        -- bajo, porque es raro que lleve comida
				{ category = "RandomClothes",          percent = 15 },
			},
		},
...

		{
			...
			classes =
			{
				{ category = "RandomConsumable",    percent = 35, min = 1, max = 2 }, -- siempre algo de comer/beber
				{ category = "RandomMedical",       percent = 25 },       -- curas frecuentes
				{ category = "RandomClothes",       percent = 10 },       -- chance baja de ropa extra
				{ category = "RandomFlashlight",    percent = 8 },        -- ocasional linterna
				{ category = "RandomCrafting",      percent = 6 },        -- material de crafteo raro
				{ category = "RandomCraftingGuide", percent = 4 },        -- muy raro
				{ category = "RandomAccessory",     percent = 3 },
				{ category = "RandomNeck",          percent = 2 },
				{ category = "RandomMXCloth",       percent = 2 },
				{ class = "AmcoinLedger",           percent = 1 }, -- drop mítico, 1%
			},
		},
...

		{
			...
			classes =
			{
				{ category = "RandomConsumable",    percent = 35 }, -- comida ligera
				{ category = "RandomMedical",       percent = 30 }, -- curas
				{ category = "RandomMXCloth",       percent = 20 }, -- tela para craftear
				{ category = "RandomCraftingGuide", percent = 10 }, -- poco común
				{ category = "Map",                 percent = 5 }, -- muy raro
			},
		},

		{
			...
			classes =
			{
				...
				{ category = "RandomFlashlight", percent = 5 },
				{ class = "AmcoinLedger",        percent = 7 },
				{ category = "RandomMXCloth",    percent = 5 },
				{ category = "RandomPainting",   percent = 5 },
			},
		},
		...
		-- Special Police Spawner
		{
			...
			classes =
			{
				{ category = "HandcuffsWithKey",                percent = 1 },
				{ category = "RandomPoliceClothing",            percent = 18 },
				{ category = "RandomCraftingGuide",             percent = 4.5 },
		...
		-- Civilian Hunting Weapons
		{
			...
			classes =
			{
				{ category = "Rem700WithRounds",                percent = 15 },
				{ category = "RandomPoliceWeaponWithMagazines", percent = 15 },
				{ category = "Rem870WithRounds",                percent = 15 },
				{ category = "Sako85WithRounds",                percent = 15 },
				{ category = "CrossbowWithMagazines",           percent = 15 },
				{ class = "HuntingKnife",                       percent = 15 },
			},
		},
		...
		-- Used in presents and easter eggs
		{
			...
			classes =
			{
				{ class = "christmas_light_string",     percent = 15 },
				{ class = "christmas_candle",           percent = 10 },
				{ class = "christmas_gift_pile",        percent = 8 },
				...
				{ class = "HockeyMaskOhOd17",           percent = 1 },
				{ class = "HockeyMaskOhOd19",           percent = 1 },
				{ class = "SAPOCBriefcaseClosed",       percent = 2.5, min = 1, max = 1 },
				{ category = "RandomEpicWeapon",        percent = 8 },
				{ category = "RandomRangedPure",        percent = 8 },
				{ category = "RandomChristmasClothing", percent = 10 },
			},
		},

		{
			...
			classes =
			{
				{ class = "snowman",                     percent = 4.5 },
				{ class = "EggNog",                      percent = 5.5 },
				{ class = "GingerBreadMan",              percent = 5.5 },
				{ category = "RandomPistol",             percent = 7 },
				{ category = "RandomSpartaGear",         percent = 8 },
				{ class = "SAPOCBriefcaseClosed",        percent = 8,   min = 1,  max = 1 },
				{ category = "RandomCargador",           percent = 7,   min = 25, max = 50 },
				{ category = "RandomRangedMilitaryPure", percent = 8 },
				{ category = "RandomRangedPolicePure",   percent = 3.5 },
				{ category = "EventHelmets",             percent = 3.5 },
				{ category = "RandomMonumento",          percent = 0.5 },
				{ category = "RandomCargador",           percent = 3.5, min = 25, max = 50 },
				{ category = "RandomAmmoBox",            percent = 4.5 },
				{ category = "RandomGnome",              percent = 4.5 },
				{ category = "RandomLantern",            percent = 4.5 },
				{ category = "RandomRangedPure",         percent = 4.5 },
				{ category = "RandomSpartaGear",         percent = 3 },
				{ category = "RandomIronSuite",          percent = 4.5 },
				{ class = "AnonMask",                    percent = 1 },
				{ class = "HockeyMaskOhOd17",            percent = 1 },
				{ class = "HockeyMaskOhOd19",            percent = 1 },
				{ class = "AmcoinLedger",                percent = 7,   min = 25, max = 50 },
			},
		},
...

		{
			...
			classes =
			{
				{ category = "RandomAmmo",                 percent = 8,  min = 1, max = 1 },
...

		{
			...
			classes =
			{
				...
				{ class = "HoodiePixelGreyGreenDesign5",   contents = "RandomTorsoContents", percent = 2 },
				{ class = "HoodiePixelGreyOrangeDesign5",  contents = "RandomTorsoContents", percent = 2 },
				...
				{ class = "PoleronMetallica",              contents = "RandomTorsoContents", percent = 2 },
			},
		},
...

		{
			...
			classes =
			{
				...
				{ class = "RainJacketOrangeBlue",    contents = "RandomTorsoContents", percent = 4 },
				{ class = "RainJacketPinkPurple",    contents = "RandomTorsoContents", percent = 4 },
				{ class = "RainJacketRed",           contents = "RandomTorsoContents", percent = 4 },
				{ class = "RainJacketRedBlue",       contents = "RandomTorsoContents", percent = 4 },
				{ class = "RainJacketRedGrey",       contents = "RandomTorsoContents", percent = 4 },
				{ class = "RainJacketYellow",        contents = "RandomTorsoContents", percent = 4 },
				{ class = "PoleronWU",               contents = "RandomTorsoContents", percent = 3 },
				{ class = "PoleronMetallica",        contents = "RandomTorsoContents", percent = 3 },
...

		{
			...
			classes =
			{
				...
				{ class = "TshirtTargetBlack",      percent = 1 },
				{ class = "TshirtTargetBlue",       percent = 1 },
...

		{
			...
			classes =
			{
				{ class = "guide_medical_bandages",           percent = 3.4482 },
				{ class = "guide_weapons_melee",              percent = 3.4482 },
				{ class = "guide_structures_tire_stacks",     percent = 3.4482 },
				{ class = "guide_ammunition",                 percent = 3.4482 },
				{ class = "guide_structures_wood_bridges_1",  percent = 3.4482 },
				{ class = "guide_structures_wood_ramps_1",    percent = 3.4482 },
				{ class = "guide_structures_wood_stairs_1",   percent = 3.4482 },
				{ class = "guide_structures_wood_traps_1",    percent = 3.4482 },
				{ class = "guide_structures_wood_walkways_1", percent = 3.4482 },
				{ class = "guide_structures_wood_walls_1",    percent = 3.4482 },
				{ class = "guide_structures_wood_roofs",      percent = 3.4482 },
				{ class = "guide_powered_parts_1",            percent = 3.4482 },
				{ class = "guide_traps_1",                    percent = 3.4482 },
				{ class = "guide_weapons_ranged_1",           percent = 3.4482 },
				{ class = "guide_structures_wood_bridges_2",  percent = 3.4482 },
				{ class = "guide_structures_wood_ramps_2",    percent = 3.4482 },
				{ class = "guide_structures_wood_stairs_2",   percent = 3.4482 },
				{ class = "guide_structures_wood_traps_2",    percent = 3.4482 },
				{ class = "guide_structures_wood_walkways_2", percent = 3.4482 },
				{ class = "guide_structures_wood_walls_2",    percent = 3.4482 },
				{ class = "guide_traps_2",                    percent = 3.4482 },
				{ class = "guide_weapons_ranged_2",           percent = 3.4482 },
				{ class = "guide_weapons_ranged_3",           percent = 3.4482 },
				{ class = "guide_buildextra",                 percent = 3.4482 },
				{ class = "guide_concrete",                   percent = 3.4482 },
				{ class = "guide_structures_wood_curves",     percent = 3.4482 },
				{ class = "guide_structures_wood_gallows",    percent = 3.4482 },
				{ class = "guide_structures_wood_watchtower", percent = 3.4482 },
				{ class = "guide_structures_wood_gatehouse",  percent = 3.4482 },
...

		{
			...
			classes =
			{
				...
				{ class = "Lighter",   percent = 40 },
				{ class = "FireDrill", percent = 10 },
		...
		-- Face
		{
			...
			classes =
			{
				...
				{ category = "RandomBandana",   percent = 30 },
				{ class = "GasMask",            percent = 5 },
				{ class = "DustMask",           percent = 14 },
				{ class = "HeadSack",           percent = 12 },
				{ class = "HockeyMask",         percent = 10 },
				{ class = "HockeyMaskDp",       percent = 6 },
				{ class = "AnonMask",           percent = 2 },
				{ class = "HockeyMaskOhOd17",   percent = 3 },
				{ class = "HockeyMaskOhOd19",   percent = 3 },
			},
		},
		...
		-- Clothes
		{
			...
			classes =
			{
				...
				{ category = "RandomHat",       percent = 11 },
				{ category = "RandomLegs",      percent = 10 },
				{ category = "RandomNeck",      percent = 10 },
				{ category = "RandomShoes",     percent = 10 },
				{ category = "RandomTorso",     percent = 10 },
...

		{
			...
			{
				-- To reduce food/water in the world these only add up to 50%
				{ category = "RandomRottenVeggie", percent = 3 },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomRottenVeggie", percent = 15 },
				{ category = "RandomVeggie",       percent = 15 },
		...
		-- Medical
		{
			...
			classes =
			{
				{ class = "AdrenalineSyringe",        percent = 2 },
				{ class = "AntiradiationPills",       percent = 3 },
				{ class = "PotassiumIodidePills",     percent = 3 },
				{ class = "Antibiotics",              percent = 3 },
				{ class = "Aspirin",                  percent = 1 },
				{ class = "Bandage",                  percent = 10 },
				{ class = "HeatPack",                 percent = 3 },
				{ class = "WaterPurificationTablets", percent = 5 },
				{ class = "Rags",                     percent = 11 },
				{ class = "RubbingAlcohol",           percent = 2 },
		...
		{
			category = "RandomFence",
			classes =
			{
				{ class = "farmfence_nz",                                 percent = 4 },
				{ class = "postonly_nz",                                  percent = 4 },
				{ class = "Clean_Fence_Mesh_nz",                          percent = 4 },
				{ class = "Clean_Doorway_Mesh_nz",                        percent = 4 },
				{ class = "Broken_Doorway_Mesh_nz",                       percent = 4 },
				{ class = "Left_Clean_Fence_Mesh_nz",                     percent = 4 },
				{ class = "Right_Clean_fence_Mesh_nz",                    percent = 4 },
				{ class = "Clean_Door_Mesh_nz",                           percent = 4 },
				{ class = "Clean_Fence_Corner_Mesh_nz",                   percent = 4 },
				{ class = "fence_chainlink_placeable_door",               percent = 4 },
				{ class = "barbwire_fence_placeable_swinging_gate_right", percent = 4 },
				{ class = "barbwire_fence_placeable_swinging_gate_posts", percent = 4 },
				{ class = "barbwire_fence_placeable_swinging_gate_left",  percent = 4 },
				{ class = "barbwire_fence_placeable_pole",                percent = 4 },
				{ class = "barbwire_fence_placeable_gate",                percent = 4 },
				{ class = "barbwire_fence_placeable_gate_rail",           percent = 4 },
				{ class = "barbwire_fence_placeable_corner_b",            percent = 4 },
				{ class = "barbwire_fence_placeable_corner_a",            percent = 4 },
				{ class = "barbwire_fence_placeable_8m",                  percent = 4 },
				{ class = "barbwire_fence_placeable_4m",                  percent = 4 },
				{ class = "barbwire_fence_placeable_2m",                  percent = 4 },
				{ class = "sliding_gate_door_double",                     percent = 4 },
				{ class = "sliding_gate_door_double_wall_2x8",            percent = 4 },
				{ class = "sliding_gate_door_wall_2x4",                   percent = 4 },
				{ class = "sliding_gate_frame_double",                    percent = 4 },
			},
		},
		...
		-- Gnomes
		{
			...
			classes =
			{
				...
				{ class = "gnome_creep",                    percent = 2 },
				{ class = "gnome_gold",                     percent = 2 },
				{ class = "gnome_silver",                   percent = 3 },
				{ class = "gnome_standard_a",               percent = 3 },
				{ class = "gnome_standard_b",               percent = 3 },
				{ class = "gnome_standard_c",               percent = 2 },
				{ class = "jerry",                          percent = 3 },
				...
				{ class = "painting_square_01",             percent = 3 },
				...
				{ class = "painting_map",                   percent = 3 },
				{ class = "hayward_painting",               percent = 2 },
				{ class = "hardpve_painting",               percent = 3 },
				{ class = "2player_painting",               percent = 2 },
				{ class = "car1_painting",                  percent = 2 },
			},
		},

		{
			...
			classes =
			{
				...
				{ class = "painting_landscape_02",          percent = 4 },
				{ class = "painting_landscape_03",          percent = 4 },
				{ class = "painting_landscape_04",          percent = 4 },
				{ class = "painting_landscape_05",          percent = 4 },
				{ class = "painting_landscape_06",          percent = 4 },
				{ class = "painting_landscape_07",          percent = 4 },
				{ class = "painting_landscape_08",          percent = 4 },
				{ class = "painting_landscape_09",          percent = 4 },
				{ class = "painting_landscape_10",          percent = 4 },
				{ class = "painting_square_01",             percent = 4 },
				{ class = "painting_square_02",             percent = 4 },
				{ class = "painting_vertical_landscape_01", percent = 4 },
				{ class = "painting_vertical_landscape_02", percent = 4 },
				{ class = "painting_vertical_landscape_03", percent = 4 },
				{ class = "painting_vertical_landscape_04", percent = 4 },
				{ class = "painting_vertical_landscape_05", percent = 4 },
				{ class = "painting_vertical_landscape_06", percent = 4 },
				{ class = "painting_map_canyonlands",       percent = 4 },
				{ class = "poster_vertical_01",             percent = 4 },
				{ class = "painting_map",                   percent = 4 },
				{ class = "hayward_painting",               percent = 4 },
				{ class = "hardpve_painting",               percent = 4 },
				{ class = "2player_painting",               percent = 4 },
				{ class = "car1_painting",                  percent = 4 },
			},
		},
		...
		-- Basebuilding Items
		{
			...
			classes =
			{
				{ category = "RandomCampingBPart", percent = 85 },
				{ category = "RandomGnome",        percent = 15 },
			},
		},
		...
		{
			category = "RandomLightColumn",
			classes =
			{
				{ class = "light_column_blue",   percent = 11.1 },
				{ class = "light_column_green",  percent = 11.1 },
				{ class = "light_column_red",    percent = 11.1 },
				{ class = "light_column_white",  percent = 11.1 },
				{ class = "light_column_yellow", percent = 11.1 },
				{ class = "light_column_purple", percent = 11.1 },
				{ class = "light_column_aqua",   percent = 11.1 },
			},
		},
...

		{
			...
			classes =
			{
				...
				{ class = "Shotgun870Tactical",   percent = 3.5 },
...

		{
			...
			classes =
			{
				{ class = "ext_762x30",          percent = 3.44 },
				{ class = "ext_556x75",          percent = 3.44 },
				{ class = "ext_762x75",          percent = 3.44 },
				{ class = "STANAGx50",           percent = 3.44 },
				{ class = "akval_drummag_75rnd", percent = 3.44 },
				{ class = "762x30",              percent = 3.44 },
				{ class = "STANAGx30",           percent = 3.44 },
				{ class = "545x30",              percent = 3.44 },
				{ class = "57x60",               percent = 3.44 },
				{ class = "g36cx50",             percent = 3.44 },
				{ class = "g36c_mag",            percent = 3.44 },
				{ class = "M40x5",               percent = 3.44 },
				{ class = "762x40",              percent = 3.44 },
				{ class = "556x100",             percent = 3.44 },
				{ class = "9x19_mac10",          percent = 3.44 },
				{ class = "ext_762x30",          percent = 3.44 },
				{ class = "ext_556x75",          percent = 3.44 },
				{ class = "ext_762x75",          percent = 3.44 },
				{ class = "556x30_ak5d",         percent = 3.44 },
				{ class = "762x20_Akval",        percent = 3.44 },
				{ class = "9mmx10_makarov",      percent = 3.44 },
				{ class = "9mmx15_m9a1",         percent = 3.44 },
				{ class = "9mmx19_ap85",         percent = 3.44 },
				{ class = "acp_45x20",           percent = 3.44 },
				{ class = "acp_45x30",           percent = 3.44 },
				{ class = "10mmx15",             percent = 3.44 },
				{ class = "10mmx30",             percent = 3.44 },
				{ class = "acp_45x10_hk",        percent = 3.44 },
				{ class = "acp_45x7",            percent = 3.44 },
			},
		},

		{
			...
			classes =
			{
				...
				{ class = "OpticScopeBow",              percent = 3 },
				{ class = "PistolSilencer",             percent = 5 },
		...
		},
		{
			...
			classes =
			{
				...
				{ class = "Pile_57x28",       percent = 6.4666, min = 1, max = 5 },
				{ class = "Pile_223",         percent = 6.4666, min = 1, max = 5 },
				{ class = "Pile_308",         percent = 6.4666, min = 1, max = 5 },
				{ class = "Pile_357",         percent = 6.4666, min = 1, max = 5 },
				{ class = "Pile_45ACP",       percent = 6.4666, min = 1, max = 5 },
				{ class = "Pile_556x45",      percent = 6.4666, min = 1, max = 5 },
				{ class = "Pile_762x39",      percent = 6.4666, min = 1, max = 5 },
				{ class = "Pile_762x51",      percent = 6.4666, min = 1, max = 5 },
				{ class = "Pile_9mm",         percent = 6.4666, min = 1, max = 5 },
				{ class = "Pile_Flare",       percent = 6.4666, min = 1, max = 5 },
				{ class = "Pile_40mmGrenade", percent = 1,      min = 1, max = 5 },
				{ category = "RandomPlasma",  percent = 1 },
				{ category = "RandomRocket",  percent = 1 },
			},
		},
		{
...

		{
			...
			{
				{ category = "RandomToolRepairKit",   percent = 5 },
				{ class = "Nails",                    percent = 5 },
				{ class = "DuctTape",                 percent = 5 },
				{ class = "Hammer",                   percent = 5 },
				{ class = "LugWrench",                percent = 5 },
				{ class = "SparkPlugs",               percent = 5 },
				{ class = "DriveBelt",                percent = 5 },
				{ class = "Icepickaxe",               percent = 0.5 },
				{ class = "PipeMetal",                percent = 5 },
				{ category = "RandomCraftingGuide",   percent = 5 },
				{ category = "RandomSilencer",        percent = 2.5 },
				{ category = "RandomTrashContent",    percent = 5 },
...

		{
			...
			classes =
			{
				{ class = "AmcoinLedger",   percent = 15, min = 1, max = 5 },
...

		{
			...
			classes =
			{
				...
				{ class = "Amalgaduino",              percent = 10, min = 1, max = 3 },
				{ category = "RandomSeeds",           percent = 4 },
...

		{
			...
			classes =
			{
				...
				{ class = "MRE",                       percent = 3 },
				{ class = "Cb_radio",                  percent = 3 },
				{ class = "SCAAMAmalgarmin",           percent = 3 },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomAmmo",                      percent = 10, min = 1, max = 1 },
				{ category = "RandomRangedMilitaryPure",        percent = 17 },
				{ category = "RandomAmmoBox",                   percent = 6,  min = 1, max = 1 },
				{ category = "RandomAccessory",                 percent = 10 },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomAmmo",            percent = 19, min = 1, max = 1 },
				{ class = "Cb_radio",                 percent = 5 },
...

		{
			...
			classes =
			{
				...
				{ category = "RandomAccessory",       percent = 5 },
				{ category = "RandomMedical",         percent = 15 },
				{ category = "RandomAmmo",            percent = 11, min = 1, max = 1 },
				{ category = "RandomSeeds",           percent = 5 },
...

		{
			...
			classes =
			{
				...
				{ class = "AmcoinLedger",           percent = 8, min = 1, max = 5 },
...

		{
			...
			classes =
			{
				{ category = "RandomAmmo",            percent = 13, min = 1, max = 1 },
				{ category = "RandomPistol",          percent = 2 },
				{ class = "AmcoinLedger",             percent = 1,  min = 1, max = 6 },
				{ category = "RandomCraftingGuide",   percent = 20 },
...

		{
			...
			classes =
			{
				{ category = "RandomAmmo",         percent = 3, min = 1, max = 1 },
				{ category = "RandomPistol",       percent = 2 },
				{ class = "AmcoinLedger",          percent = 3, min = 1, max = 6 },
...

		{
			...
			classes =
			{
				{ class = "ElectricalParts", percent = 65 },
		...
		{
			category = "RandomSteel",
			classes =
			{
				{ class = "steel_block_corner",          percent = 3.3255 },
				{ class = "steel_block_stairs2_3m",      percent = 2.3255 },
				{ class = "steel_block_stairs_3m",       percent = 3.3255 },
				{ class = "steel_block_stairs_3x4",      percent = 2.3255 },
				{ class = "steel_column_3m",             percent = 2.3255 },
				{ class = "steel_drawbridge_8m",         percent = 2.3255 },
				{ class = "steel_es_drawbridge_gate",    percent = 2.3255 },
				{ class = "steel_foundation_16m_16m",    percent = 0.3255 },
				{ class = "steel_foundation_3m_16m_16m", percent = 3.3255 },
				{ class = "steel_foundation_4m_4m",      percent = 2.3255 },
				{ class = "steel_garage",                percent = 0.3255 },
				{ class = "steel_garage_door",           percent = 0.3255 },
				{ class = "steel_gate",                  percent = 2.3255 },
				{ class = "steel_gatehouse_gate",        percent = 2.3255 },
				{ class = "steel_gate_down",             percent = 2.3255 },
				{ class = "steel_gate_house",            percent = 2.3255 },
				{ class = "steel_gate_z",                percent = 2.3255 },
				{ class = "steel_half_wall_1_2m",        percent = 2.3255 },
				{ class = "steel_half_wall_1_3m",        percent = 2.3255 },
				{ class = "steel_half_wall_1_3x3m",      percent = 3.3255 },
				{ class = "steel_longroom",              percent = 2.3255 },
				{ class = "steel_platform_16m_16m",      percent = 2.3255 },
				{ class = "steel_platform_4m_4m",        percent = 2.3255 },
				{ class = "steel_platform_4x3",          percent = 3.3255 },
				{ class = "steel_ramp_3x4",              percent = 2.3255 },
				{ class = "steel_roof",                  percent = 3.3255 },
				{ class = "steel_room_column",           percent = 2.3255 },
				{ class = "steel_room_corner",           percent = 2.3255 },
				{ class = "steel_room_c_shape",          percent = 2.3255 },
				{ class = "steel_spiralstairs",          percent = 2.3255 },
				{ class = "steel_stairs_1m_3m",          percent = 2.3255 },
				{ class = "steel_stairs_2m_1_3m",        percent = 2.3255 },
				{ class = "steel_tower_base",            percent = 2.3255 },
				{ class = "steel_tower_mid",             percent = 2.3255 },
				{ class = "steel_tower_top",             percent = 2.3255 },
				{ class = "steel_wall_3m_16m",           percent = 2.3255 },
				{ class = "steel_wall_3m_2m",            percent = 2.3255 },
				{ class = "steel_wall_3m_4m",            percent = 2.3255 },
				{ class = "steel_wall_door_3m_4m",       percent = 3.3255 },
				{ class = "steel_wall_window_3m_4m",     percent = 3.3255 },
				{ class = "vaultroom",                   percent = 1.3255 },
				{ class = "vault_slidedoor",             percent = 1.3255 },
				{ class = "x_steel_platform_4m_4m",      percent = 2.3255 },
...

		{
			...
			classes =
			{
				{ class = "plastered_wall_purple_3m_4m",               percent = 1.7543 },
				{ class = "plastered_wall_purple_3m_4m_door",          percent = 1.7543 },
				{ class = "plastered_wall_purple_3m_2m_window",        percent = 1.7543 },
				{ class = "plastered_crenelation_purple",              percent = 1.7543 },
				{ class = "plastered_wall_red_3m_2m",                  percent = 1.7543 },
				{ class = "plastered_wall_red_3m_4m_door",             percent = 1.7543 },
				{ class = "plastered_column_3m",                       percent = 1.7543 },
				{ class = "plastered_column_3m_black",                 percent = 1.7543 },
				{ class = "plastered_column_3m_blue",                  percent = 1.7543 },
				{ class = "plastered_column_3m_green",                 percent = 1.7543 },
				{ class = "plastered_column_3m_purple",                percent = 1.7543 },
				{ class = "plastered_platform_3m_4m_4m",               percent = 1.7543 },
				{ class = "plastered_platform_3m_4m_4m_stairs",        percent = 1.7543 },
				{ class = "plastered_platform_black_3m_4m_4m_stairs",  percent = 1.7543 },
				{ class = "plastered_platform_blue_3m_8m_8m",          percent = 1.7543 },
				{ class = "plastered_platform_green_3m_4m_4m",         percent = 1.7543 },
				{ class = "plastered_wall_black_3m_2m_window",         percent = 1.7543 },
				{ class = "plastered_wall_green_3m_4m_door",           percent = 1.7543 },
				{ class = "plastered_wall_red_3m_4m",                  percent = 1.7543 },
				{ class = "plastered_angled_roof_3x4x4",               percent = 1.7543 },
				{ class = "plastered_wall_3m_2m_window",               percent = 1.7543 },
				{ class = "plastered_ceiling_16m_16m_red",             percent = 1.7543 },
				{ class = "plastered_ceiling_16m_16m_purple",          percent = 1.7543 },
				{ class = "plastered_ceiling_16m_16m_green",           percent = 1.7543 },
				{ class = "plastered_ceiling_16m_16m_blue",            percent = 1.7543 },
				{ class = "plastered_ceiling_16m_16m_black",           percent = 1.7543 },
				{ class = "plastered_ceiling_16m_16m",                 percent = 1.7543 },
				{ class = "plastered_ceiling_8m_8m_red",               percent = 1.7543 },
				{ class = "plastered_ceiling_8m_8m_purple",            percent = 1.7543 },
				{ class = "plastered_ceiling_8m_8m_green",             percent = 1.7543 },
				{ class = "plastered_ceiling_8m_8m_blue",              percent = 1.7543 },
				{ class = "plastered_ceiling_8m_8m_black",             percent = 1.7543 },
				{ class = "plastered_ceiling_8m_8m",                   percent = 1.7543 },
				{ class = "plastered_ceiling_4m_4m_red",               percent = 1.7543 },
				{ class = "plastered_ceiling_4m_4m_purple",            percent = 1.7543 },
				{ class = "plastered_ceiling_4m_4m_green",             percent = 1.7543 },
				{ class = "plastered_ceiling_4m_4m_blue",              percent = 1.7543 },
				{ class = "plastered_ceiling_4m_4m_black",             percent = 1.7543 },
				{ class = "plastered_ceiling_4m_4m",                   percent = 1.7543 },
				{ class = "plastered_angled_roof_red_3x4x4",           percent = 1.7543 },
				{ class = "plastered_angled_roof_purple_3x4x4",        percent = 1.7543 },
				{ class = "plastered_angled_roof_green_3x4x4",         percent = 1.7543 },
				{ class = "plastered_angled_roof_blue_3x4x4",          percent = 1.7543 },
				{ class = "plastered_angled_roof_black_3x4x4",         percent = 1.7543 },
				{ class = "plastered_platform_red_3m_8m_8m",           percent = 1.7543 },
				{ class = "plastered_platform_red_3m_4m_4m_stairs",    percent = 1.7543 },
				{ class = "plastered_platform_red_3m_4m_4m",           percent = 1.7543 },
				{ class = "plastered_platform_purple_3m_8m_8m",        percent = 1.7543 },
				{ class = "plastered_platform_purple_3m_4m_4m_stairs", percent = 1.7543 },
				{ class = "plastered_platform_purple_3m_4m_4m",        percent = 1.7543 },
				{ class = "plastered_platform_green_3m_8m_8m",         percent = 1.7543 },
				{ class = "plastered_platform_green_3m_4m_4m_stairs",  percent = 1.7543 },
				{ class = "plastered_platform_blue_3m_4m_4m",          percent = 1.7543 },
				{ class = "plastered_platform_black_3m_8m_8m",         percent = 1.7543 },
				{ class = "plastered_platform_black_3m_4m_4m",         percent = 1.7543 },
				{ class = "plastered_platform_3m_8m_8m",               percent = 1.7543 },
				{ class = "plastered_column_3m_red",                   percent = 1.7543 },
			},
		},

		{
			...
			classes =
			{
				{ class = "one_story_white",                percent = 3 },
				{ class = "one_story_green",                percent = 5 },
				{ class = "one_story_red",                  percent = 5 },
				{ class = "one_story_black",                percent = 3 },
				{ class = "cabin_wood_black",               percent = 3 },
				{ class = "cabin_wood_simple",              percent = 3 },
				{ class = "cabin_wood_simple_black",        percent = 4 },
				{ class = "cabin_wood_simple_red",          percent = 3 },
				{ class = "cabin_wood",                     percent = 7 },
				{ class = "villa_red",                      percent = 7 },
				{ class = "villa_black",                    percent = 7 },
				{ class = "villa_white",                    percent = 6 },
				{ class = "carliftbase",                    percent = 5 },
				{ class = "carlift",                        percent = 5 },
				{ class = "barracks_middle_brick_concrete", percent = 5 },
				{ class = "carport",                        percent = 3 },
				{ class = "Shed",                           percent = 3 },
				{ class = "dws_explosive_barrel",           percent = 3 },
				{ class = "dws_acid_barrel",                percent = 3 },
				{ class = "dws_fire_extinguisher",          percent = 3 },
				{ class = "FlowerPotA_HMS",                 percent = 2 },
				{ class = "FlowerPotB_HMS",                 percent = 2 },
				{ class = "FlowerPotC_HMS",                 percent = 2 },
				{ class = "FlowerPotD_HMS",                 percent = 2 },
				{ class = "FlowerPotE_HMS",                 percent = 2 },
				{ class = "DelicateGarage_HMS",             percent = 2 },
				{ class = "DelicateGarage_Door_HMS1",       percent = 2 },
			},
		},

		{
			...
			classes =
			{
				{ class = "brick_angled_roof_3x4x4",        percent = 5 },
				{ class = "brick_ceiling_4m_4m",            percent = 10 },
				{ class = "brick_ceiling_8m_8m",            percent = 4 },
				...
				{ class = "brick_wall_3m_4m",               percent = 9 },
				{ class = "brick_wall_3m_4m_door",          percent = 1 },
				{ class = "brick_wall_3m_4m_window",        percent = 1 },
				{ class = "bigfence",                       percent = 1 },
				{ class = "bigfencecorner",                 percent = 1 },
				{ class = "bigfencecorner2",                percent = 1 },
				{ class = "bigfencegate",                   percent = 1 },
...

		{
			...
			group =
			{
				...
				{ class = "ChristmasPresentRare",        percent = 50 },
				{ class = "ChristmasHat",                percent = 30 },
				{ category = "RandomDuffelBag",          percent = 100 },
				{ category = "RandomAmmoBox",            percent = 70 },
				{ category = "RandomCargador",           percent = 70 },
				{ category = "RandomAccessory",          percent = 50 },
				{ category = "RandomIronSuite",          percent = 10 },
				{ category = "RandomSpartaGear",         percent = 25 },
				{ category = "RandomMXCloth",            percent = 30 },
				{ category = "RandomMetalParts",         percent = 40 },
				{ category = "RandomEpicWeapon",         percent = 10 },
				{ class = "StunBaton",                   percent = 20 },
				{ class = "Icepickaxe",                  percent = 10 },
				{ category = "RandomRangedMilitaryPure", percent = 50 },
				{ class = "AmcoinLedger",                percent = 2,  min = 1, max = 10 },
				{ category = "RandomTron",               percent = 5 },
				{ category = "EventHelmets",             percent = 25 },
				{ category = "RandomRangedPure",         percent = 10 },
				{ class = "GingerBreadMan",              percent = 50, min = 1, max = 3 },
				{ class = "wood_coffin",                 percent = 5 },
			},
		},
...

		{
			...
			group =
			{
				...
				{ category = "RandomRangedPure",         percent = 50 },
				{ category = "RandomAmmo",               percent = 100, min = 1,  max = 1 },
				{ category = "RandomAmmoBox",            percent = 70 },
				{ category = "RandomAccessory",          percent = 50 },
				{ category = "RandomMilitaryArmor",      percent = 40 },
				{ category = "RandomMelee",              percent = 25 },
				{ category = "RandomMilitaryClothing",   percent = 40 },
				{ category = "RandomSilencer",           percent = 20 },
				{ category = "RandomCargador",           percent = 60,  min = 10, max = 25 },
				{ class = "AmcoinLedger",                percent = 3,   min = 1,  max = 25 },
				{ category = "RandomEpicWeapon",         percent = 10 },
				{ category = "RandomEpicWeaponPure",     percent = 5 },
				{ category = "RandomTron",               percent = 2 },
				{ category = "RandomAllHazmatSuit",      percent = 20 },
				{ category = "RandomCraftingGuide",      percent = 10 },
				{ category = "SAPOCBriefcaseClosed",     percent = 0.5, min = 1,  max = 1 },
			},
		},
...

		{
			...
			group =
			{
				...
				{ category = "RandomCargador",           percent = 70 },
				{ class = "AntiradiationPills",          percent = 80, min = 1, max = 5 },
				{ class = "MushroomAntiRad",             percent = 50, min = 1, max = 3 },
				{ class = "PotassiumIodidePills",        percent = 40, min = 1, max = 3 },
				{ category = "RandomMedical",            percent = 70 },
				{ category = "RandomAllHazmatMask",      percent = 80 },
				{ category = "RandomAllHazmatSuit",      percent = 40 },
				{ category = "RandomDrink",              percent = 50 },
				{ category = "EventHelmets",             percent = 20 },
				{ category = "RandomEpicWeaponPure",     percent = 5 },
				{ class = "AmcoinLedger",                percent = 1,  min = 1, max = 10 },
				{ class = "SAPOCBriefcaseClosed",        percent = 0.2 },
			},
		},

		{
			...
			group =
			{
				-- materiales básicos, siempre algo pero en menor cantidad
				{ class = "Rags",                    percent = 60, min = 5,  max = 15 },
				{ class = "SheetMetal",              percent = 60, min = 5,  max = 20 },
				{ class = "IronIngot",               percent = 50, min = 5,  max = 15 },
				{ class = "Nails",                   percent = 50, min = 10, max = 40 },
				{ class = "ScrapMetal",              percent = 50, min = 5,  max = 30 },

				-- partes varias
				{ category = "RandomMetalParts",     percent = 50 },
				{ category = "RandomGlassParts",     percent = 30 },
				{ category = "RandomPaintCan",       percent = 25 },

				-- construcción avanzada
				{ class = "ConcreteBag",             percent = 40, min = 2,  max = 15 },
				{ class = "CamoNetting",             percent = 15, min = 2,  max = 6 },
				{ class = "WorkLight",               percent = 20, min = 1,  max = 3 },

				-- herramientas
				{ class = "Pickaxe",                 percent = 25 },
				{ class = "Hammer",                  percent = 20 },
				{ class = "Icepickaxe",              percent = 5 },

				-- guías / crafting
				{ category = "RandomCraftingGuide",  percent = 15 },
				{ category = "RandomCrafting",       percent = 25 },
				{ class = "guide_buildextra",        percent = 5 },

				-- rarezas y decorativos
				{ category = "RandomPainting",       percent = 10 },
				{ category = "RandomLightColumn",    percent = 5 },
				{ class = "SCAAMCCTVCamera",         percent = 5 },
				{ class = "UFOStorage_Crate_packed", percent = 1 },
				{ category = "RandomMonumento",      percent = 0.5 },
			},
		},
...

		{
			...
			{
				-- núcleo asegurado
				{ category = "RandomMedical",                     percent = 40, min = 1, max = 5 },
				{ category = "RandomAmmo",                        percent = 80, min = 1, max = 1 },
				{ category = "RandomAmmoBox",                     percent = 40 },
				{ category = "RandomRangedPolicePure",            percent = 70 },

				-- armas/pistolas
				{ category = "RandomMilitaryWeaponWithMagazines", percent = 40 },
				{ category = "RandomPistol",                      percent = 60 },

				-- accesorios y silenciadores
				{ category = "RandomAccessory",                   percent = 40 },
				{ category = "RandomSilencer",                    percent = 20, min = 1, max = 1 },

				-- armaduras / ropa policial
				{ category = "RandomArmorTier2",                  percent = 25 },
				{ category = "RandomPoliceArmor",                 percent = 25 },
				{ category = "RandomMilitaryHelmet",              percent = 25 },
				{ category = "RandomAllHazmatSuit",               percent = 20 },
				{ category = "EventHelmets",                      percent = 20 },

				-- loot extra (moderado)
				{ category = "RandomRangedPure",                  percent = 30 },
				{ category = "RandomSpartaGear",                  percent = 10 },
				{ category = "RandomGhillieSuit",                 percent = 10 },
				{ category = "RandomSkullCamuflaje",              percent = 10 },
				{ class = "SCAAMAmalgarmin",                      percent = 5 },
				{ category = "RandomTron",                        percent = 5 },

				-- épicos y económicos ultra raros
				{ category = "RandomEpicWeaponPure",              percent = 5 },
				{ class = "AmcoinLedger",                         percent = 2,  min = 1, max = 10 },
			},
		},
...

		{
			...
			group =
			{
				-- núcleo asegurado (siempre algo civil útil)
				{ category = "RandomRangedCivilianPure", percent = 70 },
				{ category = "RandomHuntingWeapons",     percent = 50 },
				{ category = "RandomAmmo",               percent = 60, min = 1, max = 1 },
				{ category = "RandomMedical",            percent = 50, min = 1, max = 5 },
				{ category = "RandomFood",               percent = 50 },
				{ category = "RandomLantern",            percent = 40 },
				{ category = "RandomFlashlight",         percent = 40 },
				{ category = "RandomCivilianHelmet",     percent = 30 },

				-- construcción ligera / materiales
				{ category = "RandomCargador",           percent = 40 },
				{ category = "RandomMetalParts",         percent = 25 },
				{ category = "RandomGlassParts",         percent = 20 },
				{ category = "RandomAllGasCanisterPack", percent = 25 },

				-- ropa y accesorios
				{ category = "RandomAccessory",          percent = 25 },
				{ category = "RandomHoodie",             percent = 40 },
				{ category = "RandomSkullCamuflaje",     percent = 20 },
				{ category = "RandomMXCloth",            percent = 15 },
				{ category = "RandomBinoculars",         percent = 20 },

				-- contenedores / carpas
				{ category = "SmallHidingPlaceContent",  percent = 20 },
				{ category = "RandomTent",               percent = 10, min = 1, max = 5 },

				-- raros y especiales
				{ category = "RandomAmmoBox",            percent = 20 },
				{ category = "EventHelmets",             percent = 5 },
				{ category = "RandomTron",               percent = 3 },
				{ category = "RandomEpicWeaponPure",     percent = 2 },
				{ class = "CrossbowWithMagazines",       percent = 2 },

				-- ultra raros
				{ class = "AmcoinLedger",                percent = 2,  min = 1, max = 10 },
				{ class = "SCAAMAmalgarmin",             percent = 1 },
				{ class = "SCAAMShovel",                 percent = 5 },
			},
		},
...

		{
			...
			group =
			{
				-- núcleo temático: pólvora y explosivos
				{ class = "Gunpowder",              percent = 100, min = 25, max = 100 },
				{ class = "Gunpowder",              percent = 60,  min = 25, max = 75 },
				...
				{ category = "RandomMedical",       percent = 40,  min = 1,  max = 5 },
				{ category = "RandomChemlight",     percent = 50,  min = 1,  max = 10 },
				{ category = "RandomMushroom",      percent = 30,  min = 1,  max = 5 },

				-- extras opcionales
				{ category = "RandomMaintenance",   percent = 20 },
				{ category = "RandomSmokeGrenade",  percent = 30,  min = 1,  max = 3 },
				{ category = "EventHelmets",        percent = 15 },

				-- rarezas
				{ category = "RandomEpicWeapon",    percent = 10 },
				{ category = "RandomCargador",      percent = 30 },
				{ category = "RandomFlashlight",    percent = 20 },
				{ category = "RandomMilitaryItems", percent = 20 },
				{ category = "RandomAlcohol",       percent = 15 },
				{ category = "RandomAllHazmatMask", percent = 20 },
				{ category = "RandomIronSuite",     percent = 5 },
				{ category = "RandomCraftingGuide", percent = 10 },

				{ category = "RandomSilencer",      percent = 10,  min = 1,  max = 1 },

				-- ultra raros
				{ class = "SAPOCBriefcaseClosed",   percent = 0.5 },
			},
		},
...

		{
			...
			group =
			{
				...
				{ category = "RandomMilitaryGrenade",    percent = 100 },
				{ category = "RandomMilitaryBodyArmor",  percent = 80 },
				{ category = "RandomMilitaryBodyArmor",  percent = 80 },
				{ category = "RandomFace",               percent = 70 },
				{ category = "RandomRangedPure",         percent = 5 },
				{ category = "RandomAmmo",               percent = 100, min = 1,  max = 1 },
				{ class = "Sledgehammer",                percent = 4 },
				{ category = "RandomRangedPure",         percent = 85 },
				{ category = "CrossbowWithMagazines",    percent = 100 },
				{ category = "RandomIronSuite",          percent = 20 },
				{ category = "RandomSpartaGear",         percent = 15 },
				{ class = "SCAAMAmalgarmin",             percent = 5 },
				{ category = "RandomTron",               percent = 45 },
				{ category = "RandomSilencer",           percent = 45,  min = 1,  max = 1 },
...

		{
			...
			group =
			{
				...
				{ class = "SAPOCBriefcaseClosed",          percent = 9,   min = 1,  max = 1 },
				{ class = "SAPOCBriefcaseClosed",          percent = 9,   min = 1,  max = 1 },
				{ category = "EventHelmets",               percent = 5 },
...

		{
			...
			group =
			{
				...
				{ category = "RandomMXCloth",             percent = 100 },
				{ category = "RandomSkullCamuflaje",      percent = 45 },
				{ class = "PoleronWU",                    percent = 25 },
				{ class = "PoleronMetallica",             percent = 25 },
...

		{
			...
			group =
			{
				...
				{ class = "SAPOCBriefcaseClosed",      percent = 2 },
...

		{
			...
			group =
			{
				...
				{ class = "M97",                           percent = 5 },
				{ category = "RandomPlasma",               percent = 25 },
...

		{
			...
			group =
			{
				...
				{ category = "RandomPainting", percent = 25 },
				{ category = "RandomPainting", percent = 25 },
				{ category = "RandomPainting", percent = 55 },
...

		{
			...
			group =
			{
				...
				{ category = "RandomTraderCraftingGuides", percent = 100 },
				{ category = "RandomTraderCraftingGuides", percent = 50 },
				{ category = "RandomTraderCraftingGuides", percent = 25 },
			},
		},
...

		{
			...
			classes =
			{
				...
				{ class = "RainJacketOrangeBlue",    percent = 4 },
				{ class = "RainJacketPinkPurple",    percent = 4 },
				{ class = "RainJacketRed",           percent = 4 },
				{ class = "RainJacketRedBlue",       percent = 4 },
				{ class = "RainJacketRedGrey",       percent = 4 },
				{ class = "RainJacketYellow",        percent = 4 },
				{ class = "PoleronWU",               percent = 3 },
				{ class = "PoleronMetallica",        percent = 3 },
